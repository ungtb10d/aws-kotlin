 ...
 */
public class UnsupportedPlsLanguageException private constructor(builder: Builder) : PollyException() {
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.polly.model.UnsupportedPlsLanguageException = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.polly.model.UnsupportedPlsLanguageException = Builder(this).apply(block).build()
