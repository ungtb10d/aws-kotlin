 ...
 */
public fun PollyClient.listSpeechSynthesisTasksPaginated(initialRequest: ListSpeechSynthesisTasksRequest): Flow<ListSpeechSynthesisTasksResponse> =
    flow {
 ...
 * @return A [kotlinx.coroutines.flow.Flow] that can collect [ListSpeechSynthesisTasksResponse]
 */
public fun PollyClient.listSpeechSynthesisTasksPaginated(block: ListSpeechSynthesisTasksRequest.Builder.() -> Unit): Flow<ListSpeechSynthesisTasksResponse> =
    listSpeechSynthesisTasksPaginated(ListSpeechSynthesisTasksRequest.Builder().apply(block).build())
