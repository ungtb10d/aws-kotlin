...
import aws.sdk.kotlin.services.ec2.model.LocalGatewayRouteTableMode
...
internal class CreateLocalGatewayRouteTableOperationSerializer: HttpSerialize<CreateLocalGatewayRouteTableRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateLocalGatewayRouteTableRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateLocalGatewayRouteTableOperationBody(context, input)
...
private fun serializeCreateLocalGatewayRouteTableOperationBody(context: ExecutionContext, input: CreateLocalGatewayRouteTableRequest): ByteArray {
    ...
    val MODE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, FormUrlSerialName("Mode"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateLocalGatewayRouteTableRequest"))
        trait(QueryLiteral("Action", "CreateLocalGatewayRouteTable"))
