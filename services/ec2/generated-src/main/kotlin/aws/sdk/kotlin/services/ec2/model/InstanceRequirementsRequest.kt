 ...
 */
public class InstanceRequirementsRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val acceleratorCount: aws.sdk.kotlin.services.ec2.model.AcceleratorCountRequest? = builder.acceleratorCount
    /**
     ...
     * Default: No minimum or maximum limits
     */
    public val acceleratorTotalMemoryMib: aws.sdk.kotlin.services.ec2.model.AcceleratorTotalMemoryMiBRequest? = builder.acceleratorTotalMemoryMib
    /**
     ...
     * Default: No minimum or maximum limits
     */
    public val baselineEbsBandwidthMbps: aws.sdk.kotlin.services.ec2.model.BaselineEbsBandwidthMbpsRequest? = builder.baselineEbsBandwidthMbps
    /**
     ...
     * Default: No minimum or maximum limits
     */
    public val memoryGiBPerVCpu: aws.sdk.kotlin.services.ec2.model.MemoryGiBPerVCpuRequest? = builder.memoryGiBPerVCpu
    /**
     * The minimum and maximum amount of memory, in MiB.
     */
    public val memoryMib: aws.sdk.kotlin.services.ec2.model.MemoryMiBRequest? = builder.memoryMib
    /**
     * The minimum and maximum number of network interfaces.
     *
     * Default: No minimum or maximum limits
     */
    public val networkInterfaceCount: aws.sdk.kotlin.services.ec2.model.NetworkInterfaceCountRequest? = builder.networkInterfaceCount
    /**
     ...
     * Default: No minimum or maximum limits
     */
    public val totalLocalStorageGb: aws.sdk.kotlin.services.ec2.model.TotalLocalStorageGbRequest? = builder.totalLocalStorageGb
    /**
     * The minimum and maximum number of vCPUs.
     */
    public val vCpuCount: aws.sdk.kotlin.services.ec2.model.VCpuCountRangeRequest? = builder.vCpuCount

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.InstanceRequirementsRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.InstanceRequirementsRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Default: No minimum or maximum limits
         */
        public var acceleratorCount: aws.sdk.kotlin.services.ec2.model.AcceleratorCountRequest? = null
        /**
         * Indicates whether instance types must have accelerators by specific manufacturers.
         * + For instance types with NVIDIA devices, specify `nvidia`.
         * + For instance types with AMD devices, specify `amd`.
         ...
         * Default: No minimum or maximum limits
         */
        public var acceleratorTotalMemoryMib: aws.sdk.kotlin.services.ec2.model.AcceleratorTotalMemoryMiBRequest? = null
        /**
         * The accelerator types that must be on the instance type.
         * + To include instance types with GPU hardware, specify `gpu`.
         * + To include instance types with FPGA hardware, specify `fpga`.
         ...
         * Default: No minimum or maximum limits
         */
        public var baselineEbsBandwidthMbps: aws.sdk.kotlin.services.ec2.model.BaselineEbsBandwidthMbpsRequest? = null
        /**
         * Indicates whether burstable performance T instance types are included, excluded, or required. For more information, see [Burstable performance instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html).
         * + To include burstable performance instance types, specify `included`.
         * + To require only burstable performance instance types, specify `required`.
         ...
         * Default: No minimum or maximum limits
         */
        public var memoryGiBPerVCpu: aws.sdk.kotlin.services.ec2.model.MemoryGiBPerVCpuRequest? = null
        /**
         * The minimum and maximum amount of memory, in MiB.
         */
        public var memoryMib: aws.sdk.kotlin.services.ec2.model.MemoryMiBRequest? = null
        /**
         * The minimum and maximum number of network interfaces.
         *
         * Default: No minimum or maximum limits
         */
        public var networkInterfaceCount: aws.sdk.kotlin.services.ec2.model.NetworkInterfaceCountRequest? = null
        /**
         * The price protection threshold for On-Demand Instances. This is the maximum you’ll pay for an On-Demand Instance, expressed as a percentage above the least expensive current generation M, C, or R instance type with your specified attributes. When Amazon EC2 selects instance types with your attributes, it excludes instance types priced above your threshold.
         *
         * The parameter accepts an integer, which Amazon EC2 interprets as a percentage.
         ...
         * Default: No minimum or maximum limits
         */
        public var totalLocalStorageGb: aws.sdk.kotlin.services.ec2.model.TotalLocalStorageGbRequest? = null
        /**
         * The minimum and maximum number of vCPUs.
         */
        public var vCpuCount: aws.sdk.kotlin.services.ec2.model.VCpuCountRangeRequest? = null
         ...
         */
        public fun acceleratorCount(block: aws.sdk.kotlin.services.ec2.model.AcceleratorCountRequest.Builder.() -> kotlin.Unit) {
         ...
         */
        public fun acceleratorTotalMemoryMib(block: aws.sdk.kotlin.services.ec2.model.AcceleratorTotalMemoryMiBRequest.Builder.() -> kotlin.Unit) {
         ...
         */
        public fun baselineEbsBandwidthMbps(block: aws.sdk.kotlin.services.ec2.model.BaselineEbsBandwidthMbpsRequest.Builder.() -> kotlin.Unit) {
         ...
         */
        public fun memoryGiBPerVCpu(block: aws.sdk.kotlin.services.ec2.model.MemoryGiBPerVCpuRequest.Builder.() -> kotlin.Unit) {
         ...
         */
        public fun memoryMib(block: aws.sdk.kotlin.services.ec2.model.MemoryMiBRequest.Builder.() -> kotlin.Unit) {
         ...
         */
        public fun networkInterfaceCount(block: aws.sdk.kotlin.services.ec2.model.NetworkInterfaceCountRequest.Builder.() -> kotlin.Unit) {
         ...
         */
        public fun totalLocalStorageGb(block: aws.sdk.kotlin.services.ec2.model.TotalLocalStorageGbRequest.Builder.() -> kotlin.Unit) {
         ...
         */
        public fun vCpuCount(block: aws.sdk.kotlin.services.ec2.model.VCpuCountRangeRequest.Builder.() -> kotlin.Unit) {
