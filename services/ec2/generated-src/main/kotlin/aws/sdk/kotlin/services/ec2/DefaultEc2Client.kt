...
internal class DefaultEc2Client(override val config: Ec2Client.Config) : Ec2Client {
     ...
     */
    override suspend fun createCoipCidr(input: CreateCoipCidrRequest): CreateCoipCidrResponse {
        val op = SdkHttpOperation.build<CreateCoipCidrRequest, CreateCoipCidrResponse> {
            serializer = CreateCoipCidrOperationSerializer()
            deserializer = CreateCoipCidrOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun createCoipPool(input: CreateCoipPoolRequest): CreateCoipPoolResponse {
        val op = SdkHttpOperation.build<CreateCoipPoolRequest, CreateCoipPoolResponse> {
            serializer = CreateCoipPoolOperationSerializer()
            deserializer = CreateCoipPoolOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun createLocalGatewayRouteTable(input: CreateLocalGatewayRouteTableRequest): CreateLocalGatewayRouteTableResponse {
        val op = SdkHttpOperation.build<CreateLocalGatewayRouteTableRequest, CreateLocalGatewayRouteTableResponse> {
            serializer = CreateLocalGatewayRouteTableOperationSerializer()
            deserializer = CreateLocalGatewayRouteTableOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun createLocalGatewayRouteTableVirtualInterfaceGroupAssociation(input: CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest): CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResponse {
        val op = SdkHttpOperation.build<CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest, CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResponse> {
            serializer = CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOperationSerializer()
            deserializer = CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun deleteCoipCidr(input: DeleteCoipCidrRequest): DeleteCoipCidrResponse {
        val op = SdkHttpOperation.build<DeleteCoipCidrRequest, DeleteCoipCidrResponse> {
            serializer = DeleteCoipCidrOperationSerializer()
            deserializer = DeleteCoipCidrOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun deleteCoipPool(input: DeleteCoipPoolRequest): DeleteCoipPoolResponse {
        val op = SdkHttpOperation.build<DeleteCoipPoolRequest, DeleteCoipPoolResponse> {
            serializer = DeleteCoipPoolOperationSerializer()
            deserializer = DeleteCoipPoolOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun deleteLocalGatewayRouteTable(input: DeleteLocalGatewayRouteTableRequest): DeleteLocalGatewayRouteTableResponse {
        val op = SdkHttpOperation.build<DeleteLocalGatewayRouteTableRequest, DeleteLocalGatewayRouteTableResponse> {
            serializer = DeleteLocalGatewayRouteTableOperationSerializer()
            deserializer = DeleteLocalGatewayRouteTableOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun deleteLocalGatewayRouteTableVirtualInterfaceGroupAssociation(input: DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest): DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResponse {
        val op = SdkHttpOperation.build<DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest, DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResponse> {
            serializer = DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationOperationSerializer()
            deserializer = DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun modifyLocalGatewayRoute(input: ModifyLocalGatewayRouteRequest): ModifyLocalGatewayRouteResponse {
        val op = SdkHttpOperation.build<ModifyLocalGatewayRouteRequest, ModifyLocalGatewayRouteResponse> {
            serializer = ModifyLocalGatewayRouteOperationSerializer()
            deserializer = ModifyLocalGatewayRouteOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
