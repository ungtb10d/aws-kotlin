...
public class ModifyVpcEndpointServicePermissionsRequest private constructor(builder: Builder) {
    /**
     * The Amazon Resource Names (ARN) of one or more principals. Permissions are granted to the principals in this list. To grant permissions to all principals, specify an asterisk (*).
     */
    public val addAllowedPrincipals: List<String>? = builder.addAllowedPrincipals
    /**
     ...
     */
    public val removeAllowedPrincipals: List<String>? = builder.removeAllowedPrincipals
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ModifyVpcEndpointServicePermissionsRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.ModifyVpcEndpointServicePermissionsRequest = Builder(this).apply(block).build()

    public class Builder {
        /**
         * The Amazon Resource Names (ARN) of one or more principals. Permissions are granted to the principals in this list. To grant permissions to all principals, specify an asterisk (*).
         */
        public var addAllowedPrincipals: List<String>? = null
        /**
         * Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is `DryRunOperation`. Otherwise, it is `UnauthorizedOperation`.
         */
         ...
         * The Amazon Resource Names (ARN) of one or more principals. Permissions are revoked for principals in this list.
         */
        public var removeAllowedPrincipals: List<String>? = null
        /**
         * The ID of the service.
         */
