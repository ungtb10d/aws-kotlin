...
public class StopInstancesRequest private constructor(builder: Builder) {
    /**
     ...
     *  Default: `false`
     */
    public val hibernate: kotlin.Boolean? = builder.hibernate
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.StopInstancesRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.StopInstancesRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         *  Default: `false`
         */
        public var hibernate: kotlin.Boolean? = null
        /**
         * The IDs of the instances.
         */
