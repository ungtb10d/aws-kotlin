...
internal fun deserializeIpamResourceCidrDocument(deserializer: Deserializer): IpamResourceCidr {
    ...
    val COMPLIANCESTATUS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("complianceStatus"))
    ...
    val MANAGEMENTSTATE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("managementState"))
    val OVERLAPSTATUS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("overlapStatus"))
