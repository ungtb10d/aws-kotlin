...
public class CancelConversionTaskRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val reasonMessage: kotlin.String? = builder.reasonMessage

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.CancelConversionTaskRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.CancelConversionTaskRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The reason for canceling the conversion task.
         */
        public var reasonMessage: kotlin.String? = null
