 ...
 */
public class RemovePrefixListEntry private constructor(builder: Builder) {
    /**
     * The CIDR block.
     */
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.RemovePrefixListEntry = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.RemovePrefixListEntry = Builder(this).apply(block).build()
