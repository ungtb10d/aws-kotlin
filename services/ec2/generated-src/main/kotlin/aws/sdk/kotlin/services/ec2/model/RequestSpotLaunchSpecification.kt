 ...
 */
public class RequestSpotLaunchSpecification private constructor(builder: Builder) {
    /**
     * Deprecated.
     */
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.RequestSpotLaunchSpecification = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.RequestSpotLaunchSpecification = Builder(this).apply(block).build()
