 ...
 */
public class SpotOptions private constructor(builder: Builder) {
    /**
     ...
     */
    public val maintenanceStrategies: aws.sdk.kotlin.services.ec2.model.FleetSpotMaintenanceStrategies? = builder.maintenanceStrategies
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.SpotOptions = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.SpotOptions = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The strategies for managing your workloads on your Spot Instances that will be interrupted. Currently only the capacity rebalance strategy is available.
         */
        public var maintenanceStrategies: aws.sdk.kotlin.services.ec2.model.FleetSpotMaintenanceStrategies? = null
        /**
         * The maximum amount per hour for Spot Instances that you're willing to pay. We do not recommend using this parameter because it can lead to increased interruptions. If you do not specify this parameter, you will pay the current Spot price.
         *
         * If you specify a maximum price, your Spot Instances will be interrupted more frequently than if you do not specify this parameter.
         ...
         */
        public fun maintenanceStrategies(block: aws.sdk.kotlin.services.ec2.model.FleetSpotMaintenanceStrategies.Builder.() -> kotlin.Unit) {
