...
class DescribeCarrierGatewaysResponse private constructor(builder: Builder) {
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeCarrierGatewaysResponse = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeCarrierGatewaysResponse = Builder(this).apply(block).build()

    class Builder {
        /**
         * Information about the carrier gateway.
         */
        var carrierGateways: List<CarrierGateway>? = null
        /**
         * The token to use to retrieve the next page of results. This value is null when there are no more results to return.
         */
