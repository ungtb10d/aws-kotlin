...
public class UnassignIpv6AddressesResponse private constructor(builder: Builder) {
    /**
     ...
     */
    public val unassignedIpv6Addresses: List<String>? = builder.unassignedIpv6Addresses
    /**
     * The IPv4 prefixes that have been unassigned from the network interface.
     */
    public val unassignedIpv6Prefixes: List<String>? = builder.unassignedIpv6Prefixes

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.UnassignIpv6AddressesResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.UnassignIpv6AddressesResponse = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The IPv6 addresses that have been unassigned from the network interface.
         */
        public var unassignedIpv6Addresses: List<String>? = null
        /**
         * The IPv4 prefixes that have been unassigned from the network interface.
         */
        public var unassignedIpv6Prefixes: List<String>? = null
