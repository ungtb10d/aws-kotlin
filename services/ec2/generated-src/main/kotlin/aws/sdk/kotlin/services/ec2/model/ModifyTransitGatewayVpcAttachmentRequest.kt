...
public class ModifyTransitGatewayVpcAttachmentRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val options: aws.sdk.kotlin.services.ec2.model.ModifyTransitGatewayVpcAttachmentRequestOptions? = builder.options
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ModifyTransitGatewayVpcAttachmentRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.ModifyTransitGatewayVpcAttachmentRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The new VPC attachment options.
         */
        public var options: aws.sdk.kotlin.services.ec2.model.ModifyTransitGatewayVpcAttachmentRequestOptions? = null
        /**
         * The IDs of one or more subnets to remove.
         */
         ...
         */
        public fun options(block: aws.sdk.kotlin.services.ec2.model.ModifyTransitGatewayVpcAttachmentRequestOptions.Builder.() -> kotlin.Unit) {
