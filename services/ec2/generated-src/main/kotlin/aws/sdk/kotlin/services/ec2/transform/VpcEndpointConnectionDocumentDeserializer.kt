...
internal fun deserializeVpcEndpointConnectionDocument(deserializer: Deserializer): VpcEndpointConnection {
    ...
    val VPCENDPOINTCONNECTIONID_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, XmlSerialName("vpcEndpointConnectionId"))
    ...
    val VPCENDPOINTSTATE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("vpcEndpointState"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        field(VPCENDPOINTCONNECTIONID_DESCRIPTOR)
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                ...
                VPCENDPOINTCONNECTIONID_DESCRIPTOR.index -> builder.vpcEndpointConnectionId = deserializeString()
