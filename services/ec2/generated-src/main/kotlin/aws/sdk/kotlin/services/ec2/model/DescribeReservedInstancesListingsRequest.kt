 ...
 */
class DescribeReservedInstancesListingsRequest private constructor(builder: Builder) {
    /**
     * One or more filters.
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeReservedInstancesListingsRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeReservedInstancesListingsRequest = Builder(this).apply(block).build()
