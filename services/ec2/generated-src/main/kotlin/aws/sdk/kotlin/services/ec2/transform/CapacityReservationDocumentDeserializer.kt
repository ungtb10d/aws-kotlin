...
import aws.sdk.kotlin.services.ec2.model.CapacityAllocation
...
internal fun deserializeCapacityReservationDocument(deserializer: Deserializer): CapacityReservation {
    ...
    val CAPACITYALLOCATIONS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, XmlSerialName("capacityAllocationSet"), XmlCollectionName("item"))
    ...
    val ENDDATETYPE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("endDateType"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        field(CAPACITYALLOCATIONS_DESCRIPTOR)
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                ...
                CAPACITYALLOCATIONS_DESCRIPTOR.index -> builder.capacityAllocations =
                    deserializer.deserializeList(CAPACITYALLOCATIONS_DESCRIPTOR) {
                        val col0 = mutableListOf<CapacityAllocation>()
                        while (hasNextElement()) {
                            val el0 = if (nextHasValue()) { deserializeCapacityAllocationDocument(deserializer) } else { deserializeNull(); continue }
                            col0.add(el0)
                        }
                        col0
                    }
