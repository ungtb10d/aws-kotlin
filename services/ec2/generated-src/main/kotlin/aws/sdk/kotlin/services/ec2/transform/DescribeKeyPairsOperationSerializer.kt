...
private fun serializeDescribeKeyPairsOperationBody(context: ExecutionContext, input: DescribeKeyPairsRequest): ByteArray {
    ...
    val INCLUDEPUBLICKEY_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Boolean, FormUrlSerialName("IncludePublicKey"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        field(INCLUDEPUBLICKEY_DESCRIPTOR)
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.includePublicKey?.let { field(INCLUDEPUBLICKEY_DESCRIPTOR, it) }
