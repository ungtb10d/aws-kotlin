...
public class DescribeTransitGatewayConnectPeersResponse private constructor(builder: Builder) {
    /**
     ...
     */
    public val transitGatewayConnectPeers: List<TransitGatewayConnectPeer>? = builder.transitGatewayConnectPeers

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeTransitGatewayConnectPeersResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeTransitGatewayConnectPeersResponse = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Information about the Connect peers.
         */
        public var transitGatewayConnectPeers: List<TransitGatewayConnectPeer>? = null
