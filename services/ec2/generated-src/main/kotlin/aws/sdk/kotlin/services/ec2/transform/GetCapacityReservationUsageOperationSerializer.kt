...
internal class GetCapacityReservationUsageOperationSerializer: HttpSerialize<GetCapacityReservationUsageRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetCapacityReservationUsageRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetCapacityReservationUsageOperationBody(context, input)
...
private fun serializeGetCapacityReservationUsageOperationBody(context: ExecutionContext, input: GetCapacityReservationUsageRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetCapacityReservationUsageRequest"))
        trait(QueryLiteral("Action", "GetCapacityReservationUsage"))
