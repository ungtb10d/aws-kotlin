...
public class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val localGatewayRouteTableVirtualInterfaceGroupAssociationIds: List<String>? = builder.localGatewayRouteTableVirtualInterfaceGroupAssociationIds
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The IDs of the associations.
         */
        public var localGatewayRouteTableVirtualInterfaceGroupAssociationIds: List<String>? = null
        /**
         * The maximum number of results to return with a single call. To retrieve the remaining results, make another call with the returned `nextToken` value.
         */
