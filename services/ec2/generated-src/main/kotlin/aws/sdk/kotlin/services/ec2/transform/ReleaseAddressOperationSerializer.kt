...
internal class ReleaseAddressOperationSerializer: HttpSerialize<ReleaseAddressRequest> {
    override suspend fun serialize(context: ExecutionContext, input: ReleaseAddressRequest): HttpRequestBuilder {
        ...
        val payload = serializeReleaseAddressOperationBody(context, input)
...
private fun serializeReleaseAddressOperationBody(context: ExecutionContext, input: ReleaseAddressRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("ReleaseAddressRequest"))
        trait(QueryLiteral("Action", "ReleaseAddress"))
