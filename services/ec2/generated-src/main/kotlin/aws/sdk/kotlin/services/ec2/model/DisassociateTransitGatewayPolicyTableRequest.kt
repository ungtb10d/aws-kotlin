...
public class DisassociateTransitGatewayPolicyTableRequest private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DisassociateTransitGatewayPolicyTableRequest = Builder().apply(block).build()
    }

    override fun toString(): kotlin.String = buildString {
        append("DisassociateTransitGatewayPolicyTableRequest(")
    ...
    override fun equals(other: kotlin.Any?): kotlin.Boolean {
        ...
        other as DisassociateTransitGatewayPolicyTableRequest
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DisassociateTransitGatewayPolicyTableRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.ec2.model.DisassociateTransitGatewayPolicyTableRequest) : this() {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.DisassociateTransitGatewayPolicyTableRequest = DisassociateTransitGatewayPolicyTableRequest(this)
    }
}
