...
public class DescribeIamInstanceProfileAssociationsResponse private constructor(builder: Builder) {
    /**
     * Information about the IAM instance profile associations.
     */
    public val iamInstanceProfileAssociations: List<IamInstanceProfileAssociation>? = builder.iamInstanceProfileAssociations
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeIamInstanceProfileAssociationsResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeIamInstanceProfileAssociationsResponse = Builder(this).apply(block).build()

    public class Builder {
        /**
         * Information about the IAM instance profile associations.
         */
        public var iamInstanceProfileAssociations: List<IamInstanceProfileAssociation>? = null
        /**
         * The token to use to retrieve the next page of results. This value is `null` when there are no more results to return.
         */
