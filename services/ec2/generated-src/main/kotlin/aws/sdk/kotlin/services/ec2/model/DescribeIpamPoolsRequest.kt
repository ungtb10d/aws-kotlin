...
public class DescribeIpamPoolsRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val ipamPoolIds: List<String>? = builder.ipamPoolIds
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeIpamPoolsRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeIpamPoolsRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The IDs of the IPAM pools you would like information on.
         */
        public var ipamPoolIds: List<String>? = null
        /**
         * The maximum number of results to return in the request.
         */
