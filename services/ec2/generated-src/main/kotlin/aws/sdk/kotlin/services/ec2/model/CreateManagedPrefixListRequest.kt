...
public class CreateManagedPrefixListRequest private constructor(builder: Builder) {
    /**
     * The IP address type.
     *
     ...
     */
    public val entries: List<AddPrefixListEntry>? = builder.entries
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.CreateManagedPrefixListRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.CreateManagedPrefixListRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * One or more entries for the prefix list.
         */
        public var entries: List<AddPrefixListEntry>? = null
        /**
         * The maximum number of entries for the prefix list.
         */
