...
public class CreateReplaceRootVolumeTaskResponse private constructor(builder: Builder) {
    /**
     * Information about the root volume replacement task.
     */
    public val replaceRootVolumeTask: aws.sdk.kotlin.services.ec2.model.ReplaceRootVolumeTask? = builder.replaceRootVolumeTask

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.CreateReplaceRootVolumeTaskResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.CreateReplaceRootVolumeTaskResponse = Builder(this).apply(block).build()

    public class Builder {
        /**
         * Information about the root volume replacement task.
         */
        public var replaceRootVolumeTask: aws.sdk.kotlin.services.ec2.model.ReplaceRootVolumeTask? = null
         ...
         */
        public fun replaceRootVolumeTask(block: aws.sdk.kotlin.services.ec2.model.ReplaceRootVolumeTask.Builder.() -> kotlin.Unit) {
