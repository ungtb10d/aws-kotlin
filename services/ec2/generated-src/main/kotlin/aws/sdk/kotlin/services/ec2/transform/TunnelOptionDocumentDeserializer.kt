...
internal fun deserializeTunnelOptionDocument(deserializer: Deserializer): TunnelOption {
    ...
    val LOGOPTIONS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Struct, XmlSerialName("logOptions"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                ...
                LOGOPTIONS_DESCRIPTOR.index -> builder.logOptions = deserializeVpnTunnelLogOptionsDocument(deserializer)
