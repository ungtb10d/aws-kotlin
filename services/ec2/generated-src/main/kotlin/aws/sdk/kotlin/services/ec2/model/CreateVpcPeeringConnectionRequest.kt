...
public class CreateVpcPeeringConnectionRequest private constructor(builder: Builder) {
     ...
     */
    public val peerOwnerId: kotlin.String? = builder.peerOwnerId
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.CreateVpcPeeringConnectionRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.CreateVpcPeeringConnectionRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Default: Your Amazon Web Services account ID
         */
        public var peerOwnerId: kotlin.String? = null
        /**
         * The Region code for the accepter VPC, if the accepter VPC is located in a Region other than the Region in which you make the request.
         *
         * Default: The Region in which you make the request.
