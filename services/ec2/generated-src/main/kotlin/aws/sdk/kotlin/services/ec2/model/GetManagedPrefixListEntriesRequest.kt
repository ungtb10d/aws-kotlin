...
public class GetManagedPrefixListEntriesRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val targetVersion: kotlin.Long? = builder.targetVersion

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.GetManagedPrefixListEntriesRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.GetManagedPrefixListEntriesRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The version of the prefix list for which to return the entries. The default is the current version.
         */
        public var targetVersion: kotlin.Long? = null
