...
private fun serializeDeleteIpamOperationBody(context: ExecutionContext, input: DeleteIpamRequest): ByteArray {
    ...
    val CASCADE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Boolean, FormUrlSerialName("Cascade"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        field(CASCADE_DESCRIPTOR)
        field(DRYRUN_DESCRIPTOR)
        field(IPAMID_DESCRIPTOR)
    }

    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        input.cascade?.let { field(CASCADE_DESCRIPTOR, it) }
