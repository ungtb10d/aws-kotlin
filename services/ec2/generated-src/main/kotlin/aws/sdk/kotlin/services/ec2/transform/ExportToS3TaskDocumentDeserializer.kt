...
internal fun deserializeExportToS3TaskDocument(deserializer: Deserializer): ExportToS3Task {
    ...
    val CONTAINERFORMAT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("containerFormat"))
    val DISKIMAGEFORMAT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("diskImageFormat"))
