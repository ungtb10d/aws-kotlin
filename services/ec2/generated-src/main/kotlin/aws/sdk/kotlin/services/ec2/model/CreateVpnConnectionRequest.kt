 ...
 */
public class CreateVpnConnectionRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val options: aws.sdk.kotlin.services.ec2.model.VpnConnectionOptionsSpecification? = builder.options
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.CreateVpnConnectionRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.CreateVpnConnectionRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The options for the VPN connection.
         */
        public var options: aws.sdk.kotlin.services.ec2.model.VpnConnectionOptionsSpecification? = null
        /**
         * The tags to apply to the VPN connection.
         */
         ...
         */
        public fun options(block: aws.sdk.kotlin.services.ec2.model.VpnConnectionOptionsSpecification.Builder.() -> kotlin.Unit) {
