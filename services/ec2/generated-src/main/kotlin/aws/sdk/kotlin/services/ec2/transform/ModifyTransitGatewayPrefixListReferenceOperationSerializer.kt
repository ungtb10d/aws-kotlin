...
internal class ModifyTransitGatewayPrefixListReferenceOperationSerializer: HttpSerialize<ModifyTransitGatewayPrefixListReferenceRequest> {
    override suspend fun serialize(context: ExecutionContext, input: ModifyTransitGatewayPrefixListReferenceRequest): HttpRequestBuilder {
        ...
        val payload = serializeModifyTransitGatewayPrefixListReferenceOperationBody(context, input)
...
private fun serializeModifyTransitGatewayPrefixListReferenceOperationBody(context: ExecutionContext, input: ModifyTransitGatewayPrefixListReferenceRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("ModifyTransitGatewayPrefixListReferenceRequest"))
        trait(QueryLiteral("Action", "ModifyTransitGatewayPrefixListReference"))
