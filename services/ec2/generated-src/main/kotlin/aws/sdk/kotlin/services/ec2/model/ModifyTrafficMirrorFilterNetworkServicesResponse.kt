...
public class ModifyTrafficMirrorFilterNetworkServicesResponse private constructor(builder: Builder) {
    /**
     * The Traffic Mirror filter that the network service is associated with.
     */
    public val trafficMirrorFilter: aws.sdk.kotlin.services.ec2.model.TrafficMirrorFilter? = builder.trafficMirrorFilter

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ModifyTrafficMirrorFilterNetworkServicesResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.ModifyTrafficMirrorFilterNetworkServicesResponse = Builder(this).apply(block).build()

    public class Builder {
        /**
         * The Traffic Mirror filter that the network service is associated with.
         */
        public var trafficMirrorFilter: aws.sdk.kotlin.services.ec2.model.TrafficMirrorFilter? = null
         ...
         */
        public fun trafficMirrorFilter(block: aws.sdk.kotlin.services.ec2.model.TrafficMirrorFilter.Builder.() -> kotlin.Unit) {
