...
internal class StartInstancesOperationSerializer: HttpSerialize<StartInstancesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: StartInstancesRequest): HttpRequestBuilder {
        ...
        val payload = serializeStartInstancesOperationBody(context, input)
...
private fun serializeStartInstancesOperationBody(context: ExecutionContext, input: StartInstancesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("StartInstancesRequest"))
        trait(QueryLiteral("Action", "StartInstances"))
