...
public class GetInstanceTypesFromInstanceRequirementsRequest private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.GetInstanceTypesFromInstanceRequirementsRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.GetInstanceTypesFromInstanceRequirementsRequest = Builder(this).apply(block).build()
