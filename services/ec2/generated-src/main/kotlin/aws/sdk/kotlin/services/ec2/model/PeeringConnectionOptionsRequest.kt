 ...
 */
public class PeeringConnectionOptionsRequest private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.PeeringConnectionOptionsRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.PeeringConnectionOptionsRequest = Builder(this).apply(block).build()
