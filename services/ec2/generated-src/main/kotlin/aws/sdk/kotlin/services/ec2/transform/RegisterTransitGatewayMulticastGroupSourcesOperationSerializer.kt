...
internal class RegisterTransitGatewayMulticastGroupSourcesOperationSerializer: HttpSerialize<RegisterTransitGatewayMulticastGroupSourcesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: RegisterTransitGatewayMulticastGroupSourcesRequest): HttpRequestBuilder {
        ...
        val payload = serializeRegisterTransitGatewayMulticastGroupSourcesOperationBody(context, input)
...
private fun serializeRegisterTransitGatewayMulticastGroupSourcesOperationBody(context: ExecutionContext, input: RegisterTransitGatewayMulticastGroupSourcesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("RegisterTransitGatewayMulticastGroupSourcesRequest"))
        trait(QueryLiteral("Action", "RegisterTransitGatewayMulticastGroupSources"))
