 ...
 */
public class DescribeImageAttributeRequest private constructor(builder: Builder) {
    /**
     * The AMI attribute.
     *
     ...
     */
    public val attribute: aws.sdk.kotlin.services.ec2.model.ImageAttributeName? = builder.attribute
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeImageAttributeRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeImageAttributeRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * **Note**: The `blockDeviceMapping` attribute is deprecated. Using this attribute returns the `Client.AuthFailure` error. To get information about the block device mappings for an AMI, use the DescribeImages action.
         */
        public var attribute: aws.sdk.kotlin.services.ec2.model.ImageAttributeName? = null
        /**
         * Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is `DryRunOperation`. Otherwise, it is `UnauthorizedOperation`.
         */
