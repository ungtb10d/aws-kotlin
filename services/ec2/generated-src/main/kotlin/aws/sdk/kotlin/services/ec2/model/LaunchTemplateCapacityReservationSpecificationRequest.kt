 ...
 */
public class LaunchTemplateCapacityReservationSpecificationRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val capacityReservationTarget: aws.sdk.kotlin.services.ec2.model.CapacityReservationTarget? = builder.capacityReservationTarget

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.LaunchTemplateCapacityReservationSpecificationRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.LaunchTemplateCapacityReservationSpecificationRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Information about the target Capacity Reservation or Capacity Reservation group.
         */
        public var capacityReservationTarget: aws.sdk.kotlin.services.ec2.model.CapacityReservationTarget? = null
         ...
         */
        public fun capacityReservationTarget(block: aws.sdk.kotlin.services.ec2.model.CapacityReservationTarget.Builder.() -> kotlin.Unit) {
