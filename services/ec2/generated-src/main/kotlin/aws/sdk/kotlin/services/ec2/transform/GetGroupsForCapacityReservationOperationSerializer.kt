...
internal class GetGroupsForCapacityReservationOperationSerializer: HttpSerialize<GetGroupsForCapacityReservationRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetGroupsForCapacityReservationRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetGroupsForCapacityReservationOperationBody(context, input)
...
private fun serializeGetGroupsForCapacityReservationOperationBody(context: ExecutionContext, input: GetGroupsForCapacityReservationRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetGroupsForCapacityReservationRequest"))
        trait(QueryLiteral("Action", "GetGroupsForCapacityReservation"))
