...
public class RegisterInstanceEventNotificationAttributesRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val instanceTagAttribute: aws.sdk.kotlin.services.ec2.model.RegisterInstanceTagAttributeRequest? = builder.instanceTagAttribute

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.RegisterInstanceEventNotificationAttributesRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.RegisterInstanceEventNotificationAttributesRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Information about the tag keys to register.
         */
        public var instanceTagAttribute: aws.sdk.kotlin.services.ec2.model.RegisterInstanceTagAttributeRequest? = null
         ...
         */
        public fun instanceTagAttribute(block: aws.sdk.kotlin.services.ec2.model.RegisterInstanceTagAttributeRequest.Builder.() -> kotlin.Unit) {
