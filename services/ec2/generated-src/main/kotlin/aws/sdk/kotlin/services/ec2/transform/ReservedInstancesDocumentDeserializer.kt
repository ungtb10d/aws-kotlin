...
internal fun deserializeReservedInstancesDocument(deserializer: Deserializer): ReservedInstances {
    ...
    val CURRENCYCODE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("currencyCode"))
    ...
    val OFFERINGCLASS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("offeringClass"))
    val OFFERINGTYPE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("offeringType"))
    ...
    val SCOPE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("scope"))
