...
internal fun deserializeDescribeFastLaunchImagesSuccessItemDocument(deserializer: Deserializer): DescribeFastLaunchImagesSuccessItem {
    val builder = DescribeFastLaunchImagesSuccessItem.Builder()
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("DescribeFastLaunchImagesSuccessItem"))
