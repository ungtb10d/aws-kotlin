 ...
 */
public class OnDemandOptions private constructor(builder: Builder) {
    /**
     ...
     */
    public val capacityReservationOptions: aws.sdk.kotlin.services.ec2.model.CapacityReservationOptions? = builder.capacityReservationOptions
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.OnDemandOptions = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.OnDemandOptions = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Supported only for fleets of type `instant`.
         */
        public var capacityReservationOptions: aws.sdk.kotlin.services.ec2.model.CapacityReservationOptions? = null
        /**
         * The maximum amount per hour for On-Demand Instances that you're willing to pay.
         */
         ...
         */
        public fun capacityReservationOptions(block: aws.sdk.kotlin.services.ec2.model.CapacityReservationOptions.Builder.() -> kotlin.Unit) {
