...
public class ModifyManagedPrefixListRequest private constructor(builder: Builder) {
    /**
     * One or more entries to add to the prefix list.
     */
    public val addEntries: List<AddPrefixListEntry>? = builder.addEntries
    /**
     ...
     */
    public val removeEntries: List<RemovePrefixListEntry>? = builder.removeEntries

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ModifyManagedPrefixListRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.ModifyManagedPrefixListRequest = Builder(this).apply(block).build()

    public class Builder {
        /**
         * One or more entries to add to the prefix list.
         */
        public var addEntries: List<AddPrefixListEntry>? = null
        /**
         * The current version of the prefix list.
         */
         ...
         * One or more entries to remove from the prefix list.
         */
        public var removeEntries: List<RemovePrefixListEntry>? = null
