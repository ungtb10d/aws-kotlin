...
public class GetVpnConnectionDeviceSampleConfigurationRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val internetKeyExchangeVersion: kotlin.String? = builder.internetKeyExchangeVersion
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.GetVpnConnectionDeviceSampleConfigurationRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.GetVpnConnectionDeviceSampleConfigurationRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The IKE version to be used in the sample configuration file for your customer gateway device. You can specify one of the following versions: `ikev1` or `ikev2`.
         */
        public var internetKeyExchangeVersion: kotlin.String? = null
        /**
         * Device identifier provided by the `GetVpnConnectionDeviceTypes` API.
         */
