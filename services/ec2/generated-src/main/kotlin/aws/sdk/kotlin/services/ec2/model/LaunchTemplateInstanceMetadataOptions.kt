 ...
 */
public class LaunchTemplateInstanceMetadataOptions private constructor(builder: Builder) {
    /**
     ...
     * Default: `disabled`
     */
    public val instanceMetadataTags: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataTagsState? = builder.instanceMetadataTags
    /**
     ...
     */
    public val state: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataOptionsState? = builder.state

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataOptions = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataOptions = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Default: `disabled`
         */
        public var instanceMetadataTags: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataTagsState? = null
        /**
         * The state of the metadata option changes.
         *
         * `pending` - The metadata options are being updated and the instance is not ready to process metadata traffic with the new selection.
         ...
         * `applied` - The metadata options have been successfully applied on the instance.
         */
        public var state: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataOptionsState? = null
