...
class DeleteVpnGatewayResponse private constructor(builder: Builder) {

    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DeleteVpnGatewayResponse = Builder().apply(block).build()
    }
