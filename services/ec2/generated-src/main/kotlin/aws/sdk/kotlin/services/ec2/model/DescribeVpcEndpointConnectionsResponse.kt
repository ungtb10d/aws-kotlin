...
public class DescribeVpcEndpointConnectionsResponse private constructor(builder: Builder) {
    /**
     ...
     */
    public val vpcEndpointConnections: List<VpcEndpointConnection>? = builder.vpcEndpointConnections

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeVpcEndpointConnectionsResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeVpcEndpointConnectionsResponse = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Information about one or more VPC endpoint connections.
         */
        public var vpcEndpointConnections: List<VpcEndpointConnection>? = null
