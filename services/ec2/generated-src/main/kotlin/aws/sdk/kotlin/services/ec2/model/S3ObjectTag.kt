 ...
 */
class S3ObjectTag private constructor(builder: Builder) {
    /**
     * The key of the tag.
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.S3ObjectTag = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.S3ObjectTag = Builder(this).apply(block).build()
