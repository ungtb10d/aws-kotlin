...
internal class DescribeFastLaunchImagesOperationSerializer: HttpSerialize<DescribeFastLaunchImagesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeFastLaunchImagesRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeFastLaunchImagesOperationBody(context, input)
...
private fun serializeDescribeFastLaunchImagesOperationBody(context: ExecutionContext, input: DescribeFastLaunchImagesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeFastLaunchImagesRequest"))
        trait(QueryLiteral("Action", "DescribeFastLaunchImages"))
