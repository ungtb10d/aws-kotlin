 ...
 */
class OnDemandOptionsRequest private constructor(builder: Builder) {
    /**
     ...
     */
    val capacityReservationOptions: aws.sdk.kotlin.services.ec2.model.CapacityReservationOptionsRequest? = builder.capacityReservationOptions
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.OnDemandOptionsRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.OnDemandOptionsRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * Supported only for fleets of type instant.
         */
        var capacityReservationOptions: aws.sdk.kotlin.services.ec2.model.CapacityReservationOptionsRequest? = null
        /**
         * The maximum amount per hour for On-Demand Instances that you're willing to pay.
         */
         ...
         */
        fun capacityReservationOptions(block: aws.sdk.kotlin.services.ec2.model.CapacityReservationOptionsRequest.Builder.() -> kotlin.Unit) {
