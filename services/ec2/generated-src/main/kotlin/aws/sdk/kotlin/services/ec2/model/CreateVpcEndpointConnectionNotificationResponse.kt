...
public class CreateVpcEndpointConnectionNotificationResponse private constructor(builder: Builder) {
    /**
     ...
     */
    public val connectionNotification: aws.sdk.kotlin.services.ec2.model.ConnectionNotification? = builder.connectionNotification

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.CreateVpcEndpointConnectionNotificationResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.CreateVpcEndpointConnectionNotificationResponse = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Information about the notification.
         */
        public var connectionNotification: aws.sdk.kotlin.services.ec2.model.ConnectionNotification? = null
         ...
         */
        public fun connectionNotification(block: aws.sdk.kotlin.services.ec2.model.ConnectionNotification.Builder.() -> kotlin.Unit) {
