...
public class AccountAttribute private constructor(builder: Builder) {
     ...
     */
    public val attributeValues: List<AccountAttributeValue>? = builder.attributeValues

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.AccountAttribute = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.AccountAttribute = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The values for the account attribute.
         */
        public var attributeValues: List<AccountAttributeValue>? = null
