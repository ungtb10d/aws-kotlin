...
public class DescribeTransitGatewaysRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val transitGatewayIds: List<String>? = builder.transitGatewayIds

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeTransitGatewaysRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeTransitGatewaysRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The IDs of the transit gateways.
         */
        public var transitGatewayIds: List<String>? = null
