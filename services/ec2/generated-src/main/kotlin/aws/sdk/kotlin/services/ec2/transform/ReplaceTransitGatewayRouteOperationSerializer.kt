...
internal class ReplaceTransitGatewayRouteOperationSerializer: HttpSerialize<ReplaceTransitGatewayRouteRequest> {
    override suspend fun serialize(context: ExecutionContext, input: ReplaceTransitGatewayRouteRequest): HttpRequestBuilder {
        ...
        val payload = serializeReplaceTransitGatewayRouteOperationBody(context, input)
...
private fun serializeReplaceTransitGatewayRouteOperationBody(context: ExecutionContext, input: ReplaceTransitGatewayRouteRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("ReplaceTransitGatewayRouteRequest"))
        trait(QueryLiteral("Action", "ReplaceTransitGatewayRoute"))
