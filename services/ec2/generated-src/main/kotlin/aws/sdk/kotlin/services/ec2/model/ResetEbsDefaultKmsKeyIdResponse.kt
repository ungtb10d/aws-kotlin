...
public class ResetEbsDefaultKmsKeyIdResponse private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ResetEbsDefaultKmsKeyIdResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.ResetEbsDefaultKmsKeyIdResponse = Builder(this).apply(block).build()
