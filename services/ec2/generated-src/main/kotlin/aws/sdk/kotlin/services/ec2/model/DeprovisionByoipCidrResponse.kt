...
public class DeprovisionByoipCidrResponse private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DeprovisionByoipCidrResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DeprovisionByoipCidrResponse = Builder(this).apply(block).build()
    ...
    public class Builder {
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.ec2.model.DeprovisionByoipCidrResponse) : this() {
            this.byoipCidr = x.byoipCidr
        }

        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.DeprovisionByoipCidrResponse = DeprovisionByoipCidrResponse(this)
