...
class DeprovisionByoipCidrResponse private constructor(builder: Builder) {
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DeprovisionByoipCidrResponse = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DeprovisionByoipCidrResponse = Builder(this).apply(block).build()
