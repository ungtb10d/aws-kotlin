...
internal fun deserializePlacementGroupDocument(deserializer: Deserializer): PlacementGroup {
    ...
    val SPREADLEVEL_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("spreadLevel"))
    val STATE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("state"))
    val STRATEGY_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("strategy"))
