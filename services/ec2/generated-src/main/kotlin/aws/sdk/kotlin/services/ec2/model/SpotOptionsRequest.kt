 ...
 */
class SpotOptionsRequest private constructor(builder: Builder) {
    /**
     ...
     * interrupted.
     */
    val maintenanceStrategies: aws.sdk.kotlin.services.ec2.model.FleetSpotMaintenanceStrategiesRequest? = builder.maintenanceStrategies
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.SpotOptionsRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.SpotOptionsRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * interrupted.
         */
        var maintenanceStrategies: aws.sdk.kotlin.services.ec2.model.FleetSpotMaintenanceStrategiesRequest? = null
        /**
         * The maximum amount per hour for Spot Instances that you're willing to pay.
         */
         ...
         */
        fun maintenanceStrategies(block: aws.sdk.kotlin.services.ec2.model.FleetSpotMaintenanceStrategiesRequest.Builder.() -> kotlin.Unit) {
