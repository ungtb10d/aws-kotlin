 ...
 */
class FleetLaunchTemplateConfig private constructor(builder: Builder) {
    /**
     * The launch template.
     */
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.FleetLaunchTemplateConfig = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.FleetLaunchTemplateConfig = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * template.
         */
        var overrides: List<FleetLaunchTemplateOverrides>? = null
