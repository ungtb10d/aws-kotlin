 ...
 */
public class FleetLaunchTemplateConfig private constructor(builder: Builder) {
    /**
     * The launch template.
     */
     ...
     */
    public val overrides: List<FleetLaunchTemplateOverrides>? = builder.overrides

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.FleetLaunchTemplateConfig = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.FleetLaunchTemplateConfig = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Any parameters that you specify override the same parameters in the launch template.
         */
        public var overrides: List<FleetLaunchTemplateOverrides>? = null

        @PublishedApi
        internal constructor()
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.ec2.model.FleetLaunchTemplateConfig) : this() {
            this.launchTemplateSpecification = x.launchTemplateSpecification
            this.overrides = x.overrides
        }

        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.FleetLaunchTemplateConfig = FleetLaunchTemplateConfig(this)
