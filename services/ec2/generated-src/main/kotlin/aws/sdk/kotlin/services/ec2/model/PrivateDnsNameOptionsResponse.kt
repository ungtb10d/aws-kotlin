 ...
 */
public class PrivateDnsNameOptionsResponse private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.PrivateDnsNameOptionsResponse = Builder().apply(block).build()
    }

    override fun toString(): kotlin.String = buildString {
        append("PrivateDnsNameOptionsResponse(")
    ...
    override fun equals(other: kotlin.Any?): kotlin.Boolean {
        ...
        other as PrivateDnsNameOptionsResponse
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.PrivateDnsNameOptionsResponse = Builder(this).apply(block).build()
    ...
    public class Builder {
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.ec2.model.PrivateDnsNameOptionsResponse) : this() {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.PrivateDnsNameOptionsResponse = PrivateDnsNameOptionsResponse(this)
    }
}
