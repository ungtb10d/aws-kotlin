...
internal fun deserializeEbsInfoDocument(deserializer: Deserializer): EbsInfo {
    ...
    val EBSOPTIMIZEDSUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("ebsOptimizedSupport"))
    val ENCRYPTIONSUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("encryptionSupport"))
    val NVMESUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("nvmeSupport"))
