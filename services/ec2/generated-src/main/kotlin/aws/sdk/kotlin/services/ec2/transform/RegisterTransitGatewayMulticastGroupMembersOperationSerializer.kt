...
internal class RegisterTransitGatewayMulticastGroupMembersOperationSerializer: HttpSerialize<RegisterTransitGatewayMulticastGroupMembersRequest> {
    override suspend fun serialize(context: ExecutionContext, input: RegisterTransitGatewayMulticastGroupMembersRequest): HttpRequestBuilder {
        ...
        val payload = serializeRegisterTransitGatewayMulticastGroupMembersOperationBody(context, input)
...
private fun serializeRegisterTransitGatewayMulticastGroupMembersOperationBody(context: ExecutionContext, input: RegisterTransitGatewayMulticastGroupMembersRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("RegisterTransitGatewayMulticastGroupMembersRequest"))
        trait(QueryLiteral("Action", "RegisterTransitGatewayMulticastGroupMembers"))
