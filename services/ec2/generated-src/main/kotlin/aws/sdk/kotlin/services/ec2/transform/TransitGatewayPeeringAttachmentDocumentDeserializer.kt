...
internal fun deserializeTransitGatewayPeeringAttachmentDocument(deserializer: Deserializer): TransitGatewayPeeringAttachment {
    ...
    val ACCEPTERTRANSITGATEWAYATTACHMENTID_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, XmlSerialName("accepterTransitGatewayAttachmentId"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        field(ACCEPTERTRANSITGATEWAYATTACHMENTID_DESCRIPTOR)
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                ...
                ACCEPTERTRANSITGATEWAYATTACHMENTID_DESCRIPTOR.index -> builder.accepterTransitGatewayAttachmentId = deserializeString()
                CREATIONTIME_DESCRIPTOR.index -> builder.creationTime = deserializeString().let { Instant.fromIso8601(it) }
                OPTIONS_DESCRIPTOR.index -> builder.options = deserializeTransitGatewayPeeringAttachmentOptionsDocument(deserializer)
