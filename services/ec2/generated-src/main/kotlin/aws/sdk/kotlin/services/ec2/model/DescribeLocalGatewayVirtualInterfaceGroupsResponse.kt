...
public class DescribeLocalGatewayVirtualInterfaceGroupsResponse private constructor(builder: Builder) {
    /**
     * The virtual interface groups.
     */
    public val localGatewayVirtualInterfaceGroups: List<LocalGatewayVirtualInterfaceGroup>? = builder.localGatewayVirtualInterfaceGroups
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeLocalGatewayVirtualInterfaceGroupsResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeLocalGatewayVirtualInterfaceGroupsResponse = Builder(this).apply(block).build()

    public class Builder {
        /**
         * The virtual interface groups.
         */
        public var localGatewayVirtualInterfaceGroups: List<LocalGatewayVirtualInterfaceGroup>? = null
        /**
         * The token to use to retrieve the next page of results. This value is `null` when there are no more results to return.
         */
