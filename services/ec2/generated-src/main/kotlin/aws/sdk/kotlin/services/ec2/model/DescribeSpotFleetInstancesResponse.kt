 ...
 */
public class DescribeSpotFleetInstancesResponse private constructor(builder: Builder) {
    /**
     * The running instances. This list is refreshed periodically and might be out of date.
     */
    public val activeInstances: List<ActiveInstance>? = builder.activeInstances
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeSpotFleetInstancesResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeSpotFleetInstancesResponse = Builder(this).apply(block).build()

    public class Builder {
        /**
         * The running instances. This list is refreshed periodically and might be out of date.
         */
        public var activeInstances: List<ActiveInstance>? = null
        /**
         * The token required to retrieve the next set of results. This value is `null` when there are no more results to return.
         */
