...
public class ModifyVpcPeeringConnectionOptionsResponse private constructor(builder: Builder) {
    /**
     * Information about the VPC peering connection options for the accepter VPC.
     */
    public val accepterPeeringConnectionOptions: aws.sdk.kotlin.services.ec2.model.PeeringConnectionOptions? = builder.accepterPeeringConnectionOptions
    /**
     * Information about the VPC peering connection options for the requester VPC.
     */
    public val requesterPeeringConnectionOptions: aws.sdk.kotlin.services.ec2.model.PeeringConnectionOptions? = builder.requesterPeeringConnectionOptions

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ModifyVpcPeeringConnectionOptionsResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.ModifyVpcPeeringConnectionOptionsResponse = Builder(this).apply(block).build()

    public class Builder {
        /**
         * Information about the VPC peering connection options for the accepter VPC.
         */
        public var accepterPeeringConnectionOptions: aws.sdk.kotlin.services.ec2.model.PeeringConnectionOptions? = null
        /**
         * Information about the VPC peering connection options for the requester VPC.
         */
        public var requesterPeeringConnectionOptions: aws.sdk.kotlin.services.ec2.model.PeeringConnectionOptions? = null
         ...
         */
        public fun accepterPeeringConnectionOptions(block: aws.sdk.kotlin.services.ec2.model.PeeringConnectionOptions.Builder.() -> kotlin.Unit) {
         ...
         * construct an [aws.sdk.kotlin.services.ec2.model.PeeringConnectionOptions] inside the given [block]
         */
        public fun requesterPeeringConnectionOptions(block: aws.sdk.kotlin.services.ec2.model.PeeringConnectionOptions.Builder.() -> kotlin.Unit) {
