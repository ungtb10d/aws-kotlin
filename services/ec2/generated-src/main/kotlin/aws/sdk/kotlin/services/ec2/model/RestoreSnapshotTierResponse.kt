...
public class RestoreSnapshotTierResponse private constructor(builder: Builder) {
    /**
     ...
     */
    public val isPermanentRestore: kotlin.Boolean? = builder.isPermanentRestore
    /**
     * For temporary restores only. The number of days for which the archived snapshot is temporarily restored.
     */
    public val restoreDuration: kotlin.Int? = builder.restoreDuration
    /**
     * The date and time when the snapshot restore process started.
     */
    public val restoreStartTime: aws.smithy.kotlin.runtime.time.Instant? = builder.restoreStartTime
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.RestoreSnapshotTierResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.RestoreSnapshotTierResponse = Builder(this).apply(block).build()

    public class Builder {
        /**
         * Indicates whether the snapshot is permanently restored. `true` indicates a permanent restore. `false` indicates a temporary restore.
         */
        public var isPermanentRestore: kotlin.Boolean? = null
        /**
         * For temporary restores only. The number of days for which the archived snapshot is temporarily restored.
         */
        public var restoreDuration: kotlin.Int? = null
        /**
         * The date and time when the snapshot restore process started.
         */
        public var restoreStartTime: aws.smithy.kotlin.runtime.time.Instant? = null
        /**
         * The ID of the snapshot.
         */
