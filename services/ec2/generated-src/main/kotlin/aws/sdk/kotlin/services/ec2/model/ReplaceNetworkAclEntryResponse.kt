...
public class ReplaceNetworkAclEntryResponse private constructor(builder: Builder) {

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ReplaceNetworkAclEntryResponse = Builder().apply(block).build()
    }
