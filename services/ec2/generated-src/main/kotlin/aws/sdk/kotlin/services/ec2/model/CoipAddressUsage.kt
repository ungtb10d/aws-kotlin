 ...
 */
public class CoipAddressUsage private constructor(builder: Builder) {
    /**
     ...
     */
    public val coIp: kotlin.String? = builder.coIp

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.CoipAddressUsage = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.CoipAddressUsage = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The customer-owned IP address.
         */
        public var coIp: kotlin.String? = null
