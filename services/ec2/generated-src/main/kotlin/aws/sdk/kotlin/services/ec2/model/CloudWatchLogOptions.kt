 ...
 */
public class CloudWatchLogOptions private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.CloudWatchLogOptions = Builder().apply(block).build()
    }

    override fun toString(): kotlin.String = buildString {
        append("CloudWatchLogOptions(")
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.CloudWatchLogOptions = Builder(this).apply(block).build()
    ...
    public class Builder {
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.ec2.model.CloudWatchLogOptions) : this() {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.CloudWatchLogOptions = CloudWatchLogOptions(this)
    }
}
