...
internal fun deserializeImageDocument(deserializer: Deserializer): Image {
    ...
    val ARCHITECTURE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("architecture"))
    ...
    val BOOTMODE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("bootMode"))
    ...
    val IMAGETYPE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("imageType"))
    ...
    val ROOTDEVICETYPE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("rootDeviceType"))
    val SRIOVNETSUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, XmlSerialName("sriovNetSupport"))
    val STATE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("imageState"))
    val STATEREASON_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Struct, XmlSerialName("stateReason"))
    val TAGS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, XmlSerialName("tagSet"), XmlCollectionName("item"))
    val TPMSUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("tpmSupport"))
    val USAGEOPERATION_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, XmlSerialName("usageOperation"))
    val VIRTUALIZATIONTYPE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("virtualizationType"))
