...
public class ModifyTrafficMirrorFilterRuleRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val destinationPortRange: aws.sdk.kotlin.services.ec2.model.TrafficMirrorPortRangeRequest? = builder.destinationPortRange
    /**
     ...
     */
    public val removeFields: List<TrafficMirrorFilterRuleField>? = builder.removeFields
    /**
     ...
     */
    public val sourcePortRange: aws.sdk.kotlin.services.ec2.model.TrafficMirrorPortRangeRequest? = builder.sourcePortRange
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ModifyTrafficMirrorFilterRuleRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.ModifyTrafficMirrorFilterRuleRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The destination ports that are associated with the Traffic Mirror rule.
         */
        public var destinationPortRange: aws.sdk.kotlin.services.ec2.model.TrafficMirrorPortRangeRequest? = null
        /**
         * Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is `DryRunOperation`. Otherwise, it is `UnauthorizedOperation`.
         */
         ...
         * When you remove a property from a Traffic Mirror filter rule, the property is set to the default.
         */
        public var removeFields: List<TrafficMirrorFilterRuleField>? = null
        /**
         * The action to assign to the rule.
         */
         ...
         * The port range to assign to the Traffic Mirror rule.
         */
        public var sourcePortRange: aws.sdk.kotlin.services.ec2.model.TrafficMirrorPortRangeRequest? = null
        /**
         * The type of traffic to assign to the rule.
         */
         ...
         */
        public fun destinationPortRange(block: aws.sdk.kotlin.services.ec2.model.TrafficMirrorPortRangeRequest.Builder.() -> kotlin.Unit) {
         ...
         * construct an [aws.sdk.kotlin.services.ec2.model.TrafficMirrorPortRangeRequest] inside the given [block]
         */
        public fun sourcePortRange(block: aws.sdk.kotlin.services.ec2.model.TrafficMirrorPortRangeRequest.Builder.() -> kotlin.Unit) {
