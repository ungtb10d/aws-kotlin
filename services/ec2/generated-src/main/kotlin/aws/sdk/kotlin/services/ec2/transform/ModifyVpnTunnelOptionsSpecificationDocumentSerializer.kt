...
internal fun serializeModifyVpnTunnelOptionsSpecificationDocument(serializer: Serializer, input: ModifyVpnTunnelOptionsSpecification) {
    ...
    val LOGOPTIONS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Struct, FormUrlSerialName("LogOptions"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.logOptions?.let { field(LOGOPTIONS_DESCRIPTOR, it, ::serializeVpnTunnelLogOptionsSpecificationDocument) }
    }
}
