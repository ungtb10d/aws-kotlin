...
internal fun serializeExportToS3TaskSpecificationDocument(serializer: Serializer, input: ExportToS3TaskSpecification) {
    val CONTAINERFORMAT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, FormUrlSerialName("ContainerFormat"))
    val DISKIMAGEFORMAT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, FormUrlSerialName("DiskImageFormat"))
