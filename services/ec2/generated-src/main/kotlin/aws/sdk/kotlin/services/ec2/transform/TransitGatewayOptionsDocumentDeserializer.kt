...
internal fun deserializeTransitGatewayOptionsDocument(deserializer: Deserializer): TransitGatewayOptions {
    ...
    val AUTOACCEPTSHAREDATTACHMENTS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("autoAcceptSharedAttachments"))
    val DEFAULTROUTETABLEASSOCIATION_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("defaultRouteTableAssociation"))
    val DEFAULTROUTETABLEPROPAGATION_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("defaultRouteTablePropagation"))
    val DNSSUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("dnsSupport"))
    val MULTICASTSUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("multicastSupport"))
    ...
    val VPNECMPSUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("vpnEcmpSupport"))
