...
internal class CreateTransitGatewayRouteOperationSerializer: HttpSerialize<CreateTransitGatewayRouteRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateTransitGatewayRouteRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateTransitGatewayRouteOperationBody(context, input)
...
private fun serializeCreateTransitGatewayRouteOperationBody(context: ExecutionContext, input: CreateTransitGatewayRouteRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateTransitGatewayRouteRequest"))
        trait(QueryLiteral("Action", "CreateTransitGatewayRoute"))
