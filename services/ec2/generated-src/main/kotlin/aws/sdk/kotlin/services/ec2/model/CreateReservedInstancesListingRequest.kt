 ...
 */
public class CreateReservedInstancesListingRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val priceSchedules: List<PriceScheduleSpecification>? = builder.priceSchedules
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.CreateReservedInstancesListingRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.CreateReservedInstancesListingRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * A list specifying the price of the Standard Reserved Instance for each month remaining in the Reserved Instance term.
         */
        public var priceSchedules: List<PriceScheduleSpecification>? = null
        /**
         * The ID of the active Standard Reserved Instance.
         */
