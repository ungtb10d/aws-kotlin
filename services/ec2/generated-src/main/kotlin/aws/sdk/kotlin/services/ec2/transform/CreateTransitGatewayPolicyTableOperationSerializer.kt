...
internal class CreateTransitGatewayPolicyTableOperationSerializer: HttpSerialize<CreateTransitGatewayPolicyTableRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateTransitGatewayPolicyTableRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateTransitGatewayPolicyTableOperationBody(context, input)
...
private fun serializeCreateTransitGatewayPolicyTableOperationBody(context: ExecutionContext, input: CreateTransitGatewayPolicyTableRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateTransitGatewayPolicyTableRequest"))
        trait(QueryLiteral("Action", "CreateTransitGatewayPolicyTable"))
