...
private fun serializeRegisterImageOperationBody(context: ExecutionContext, input: RegisterImageRequest): ByteArray {
    ...
    val BOOTMODE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, FormUrlSerialName("BootMode"))
    ...
    val TPMSUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, FormUrlSerialName("TpmSupport"))
