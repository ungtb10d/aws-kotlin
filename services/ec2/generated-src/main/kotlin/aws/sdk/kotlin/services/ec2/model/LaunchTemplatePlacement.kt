 ...
 */
class LaunchTemplatePlacement private constructor(builder: Builder) {
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.LaunchTemplatePlacement = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.LaunchTemplatePlacement = Builder(this).apply(block).build()
    ...
    class Builder {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.LaunchTemplatePlacement = LaunchTemplatePlacement(this)
    }
}
