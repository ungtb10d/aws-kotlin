...
public class DisassociateTransitGatewayMulticastDomainRequest private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DisassociateTransitGatewayMulticastDomainRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DisassociateTransitGatewayMulticastDomainRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.ec2.model.DisassociateTransitGatewayMulticastDomainRequest) : this() {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.DisassociateTransitGatewayMulticastDomainRequest = DisassociateTransitGatewayMulticastDomainRequest(this)
    }
}
