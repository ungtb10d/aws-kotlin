...
class DescribeInstanceStatusResponse private constructor(builder: Builder) {
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeInstanceStatusResponse = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeInstanceStatusResponse = Builder(this).apply(block).build()

    class Builder {
        /**
         * Information about the status of the instances.
         */
        var instanceStatuses: List<InstanceStatus>? = null
        /**
         * The token to use to retrieve the next page of results. This value is null
         * when there are no more results to return.
         */
