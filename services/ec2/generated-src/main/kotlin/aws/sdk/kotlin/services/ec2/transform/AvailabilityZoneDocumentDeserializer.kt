...
internal fun deserializeAvailabilityZoneDocument(deserializer: Deserializer): AvailabilityZone {
    ...
    val OPTINSTATUS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("optInStatus"))
    ...
    val STATE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("zoneState"))
