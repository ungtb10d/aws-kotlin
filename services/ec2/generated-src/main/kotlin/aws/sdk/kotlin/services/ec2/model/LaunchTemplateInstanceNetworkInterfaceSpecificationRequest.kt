 ...
 */
public class LaunchTemplateInstanceNetworkInterfaceSpecificationRequest private constructor(builder: Builder) {
    /**
     ...
     */
    public val ipv6Addresses: List<InstanceIpv6AddressRequest>? = builder.ipv6Addresses
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceNetworkInterfaceSpecificationRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceNetworkInterfaceSpecificationRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * One or more specific IPv6 addresses from the IPv6 CIDR block range of your subnet. You can't use this option if you're specifying a number of IPv6 addresses.
         */
        public var ipv6Addresses: List<InstanceIpv6AddressRequest>? = null
        /**
         * The number of IPv6 prefixes to be automatically assigned to the network interface. You cannot use this option if you use the `Ipv6Prefix` option.
         */
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceNetworkInterfaceSpecificationRequest) : this() {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceNetworkInterfaceSpecificationRequest = LaunchTemplateInstanceNetworkInterfaceSpecificationRequest(this)
    }
}
