...
public class DescribeAggregateIdFormatResponse private constructor(builder: Builder) {
    /**
     ...
     */
    public val useLongIdsAggregated: kotlin.Boolean? = builder.useLongIdsAggregated

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeAggregateIdFormatResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeAggregateIdFormatResponse = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Indicates whether all resource types in the Region are configured to use longer IDs. This value is only `true` if all users are configured to use longer IDs for all resources types in the Region.
         */
        public var useLongIdsAggregated: kotlin.Boolean? = null
