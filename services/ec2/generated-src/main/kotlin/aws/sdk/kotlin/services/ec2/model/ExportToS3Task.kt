 ...
 */
public class ExportToS3Task private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ExportToS3Task = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.ExportToS3Task = Builder(this).apply(block).build()
    ...
    public class Builder {
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.ec2.model.ExportToS3Task) : this() {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.ExportToS3Task = ExportToS3Task(this)
    }
}
