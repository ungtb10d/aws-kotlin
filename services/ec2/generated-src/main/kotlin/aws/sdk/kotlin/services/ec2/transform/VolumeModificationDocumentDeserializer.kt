...
internal fun deserializeVolumeModificationDocument(deserializer: Deserializer): VolumeModification {
    ...
    val MODIFICATIONSTATE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("modificationState"))
    ...
    val ORIGINALVOLUMETYPE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("originalVolumeType"))
    ...
    val TARGETVOLUMETYPE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, XmlSerialName("targetVolumeType"))
