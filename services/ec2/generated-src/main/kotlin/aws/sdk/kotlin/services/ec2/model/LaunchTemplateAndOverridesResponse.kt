 ...
 */
public class LaunchTemplateAndOverridesResponse private constructor(builder: Builder) {
    /**
     * The launch template.
     */
     ...
     */
    public val overrides: aws.sdk.kotlin.services.ec2.model.FleetLaunchTemplateOverrides? = builder.overrides

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.LaunchTemplateAndOverridesResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.LaunchTemplateAndOverridesResponse = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Any parameters that you specify override the same parameters in the launch template.
         */
        public var overrides: aws.sdk.kotlin.services.ec2.model.FleetLaunchTemplateOverrides? = null
         ...
         */
        public fun overrides(block: aws.sdk.kotlin.services.ec2.model.FleetLaunchTemplateOverrides.Builder.() -> kotlin.Unit) {
