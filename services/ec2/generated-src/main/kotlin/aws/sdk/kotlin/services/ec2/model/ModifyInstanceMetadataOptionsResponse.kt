...
public class ModifyInstanceMetadataOptionsResponse private constructor(builder: Builder) {
    /**
     ...
     */
    public val instanceMetadataOptions: aws.sdk.kotlin.services.ec2.model.InstanceMetadataOptionsResponse? = builder.instanceMetadataOptions

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ModifyInstanceMetadataOptionsResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.ModifyInstanceMetadataOptionsResponse = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The metadata options for the instance.
         */
        public var instanceMetadataOptions: aws.sdk.kotlin.services.ec2.model.InstanceMetadataOptionsResponse? = null
         ...
         */
        public fun instanceMetadataOptions(block: aws.sdk.kotlin.services.ec2.model.InstanceMetadataOptionsResponse.Builder.() -> kotlin.Unit) {
