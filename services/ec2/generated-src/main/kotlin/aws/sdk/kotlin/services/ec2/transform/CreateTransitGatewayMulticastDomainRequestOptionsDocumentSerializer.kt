...
internal fun serializeCreateTransitGatewayMulticastDomainRequestOptionsDocument(serializer: Serializer, input: CreateTransitGatewayMulticastDomainRequestOptions) {
    val AUTOACCEPTSHAREDASSOCIATIONS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, FormUrlSerialName("AutoAcceptSharedAssociations"))
    val IGMPV2SUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, FormUrlSerialName("Igmpv2Support"))
    val STATICSOURCESSUPPORT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Enum, FormUrlSerialName("StaticSourcesSupport"))
