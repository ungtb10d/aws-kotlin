...
public class RecurringCharge private constructor(builder: Builder) {
     ...
     */
    public val frequency: aws.sdk.kotlin.services.ec2.model.RecurringChargeFrequency? = builder.frequency

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.RecurringCharge = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.RecurringCharge = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The frequency of the recurring charge.
         */
        public var frequency: aws.sdk.kotlin.services.ec2.model.RecurringChargeFrequency? = null
