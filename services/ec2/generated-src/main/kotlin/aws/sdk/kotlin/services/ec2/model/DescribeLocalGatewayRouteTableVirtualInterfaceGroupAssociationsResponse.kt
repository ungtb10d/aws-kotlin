...
public class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsResponse private constructor(builder: Builder) {
    /**
     * Information about the associations.
     */
    public val localGatewayRouteTableVirtualInterfaceGroupAssociations: List<LocalGatewayRouteTableVirtualInterfaceGroupAssociation>? = builder.localGatewayRouteTableVirtualInterfaceGroupAssociations
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsResponse = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsResponse = Builder(this).apply(block).build()

    public class Builder {
        /**
         * Information about the associations.
         */
        public var localGatewayRouteTableVirtualInterfaceGroupAssociations: List<LocalGatewayRouteTableVirtualInterfaceGroupAssociation>? = null
        /**
         * The token to use to retrieve the next page of results. This value is `null` when there are no more results to return.
         */
