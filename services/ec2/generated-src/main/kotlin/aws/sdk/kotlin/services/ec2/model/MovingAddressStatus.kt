 ...
 */
public class MovingAddressStatus private constructor(builder: Builder) {
    /**
     * The status of the Elastic IP address that's being moved to the EC2-VPC platform, or restored to the EC2-Classic platform.
     */
    public val moveStatus: aws.sdk.kotlin.services.ec2.model.MoveStatus? = builder.moveStatus
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.MovingAddressStatus = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.MovingAddressStatus = Builder(this).apply(block).build()

    public class Builder {
        /**
         * The status of the Elastic IP address that's being moved to the EC2-VPC platform, or restored to the EC2-Classic platform.
         */
        public var moveStatus: aws.sdk.kotlin.services.ec2.model.MoveStatus? = null
        /**
         * The Elastic IP address.
         */
