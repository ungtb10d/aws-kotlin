 ...
 */
public class ResourceStatement private constructor(builder: Builder) {
    /**
     * The resource types.
     */
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.ResourceStatement = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.ResourceStatement = Builder(this).apply(block).build()
