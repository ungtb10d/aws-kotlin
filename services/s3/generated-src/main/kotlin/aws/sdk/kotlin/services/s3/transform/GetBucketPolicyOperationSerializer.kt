...
internal class GetBucketPolicyOperationSerializer: HttpSerialize<GetBucketPolicyRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetBucketPolicyRequest): HttpRequestBuilder {
