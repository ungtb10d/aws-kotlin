...
internal class DeleteObjectTaggingOperationSerializer: HttpSerialize<DeleteObjectTaggingRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DeleteObjectTaggingRequest): HttpRequestBuilder {
