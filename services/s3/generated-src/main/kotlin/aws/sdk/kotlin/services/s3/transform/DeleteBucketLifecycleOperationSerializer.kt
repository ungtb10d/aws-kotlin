...
internal class DeleteBucketLifecycleOperationSerializer: HttpSerialize<DeleteBucketLifecycleRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DeleteBucketLifecycleRequest): HttpRequestBuilder {
