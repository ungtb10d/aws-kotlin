...
public class GetObjectTaggingRequest private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.GetObjectTaggingRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.GetObjectTaggingRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.s3.model.GetObjectTaggingRequest) : this() {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.s3.model.GetObjectTaggingRequest = GetObjectTaggingRequest(this)
    }
}
