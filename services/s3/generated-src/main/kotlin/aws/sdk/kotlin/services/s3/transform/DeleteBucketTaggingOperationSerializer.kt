...
internal class DeleteBucketTaggingOperationSerializer: HttpSerialize<DeleteBucketTaggingRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DeleteBucketTaggingRequest): HttpRequestBuilder {
