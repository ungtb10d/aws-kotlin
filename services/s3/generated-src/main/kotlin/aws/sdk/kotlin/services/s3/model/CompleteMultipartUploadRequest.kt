...
class CompleteMultipartUploadRequest private constructor(builder: Builder) {
    /**
     ...
     */
    val multipartUpload: aws.sdk.kotlin.services.s3.model.CompletedMultipartUpload? = builder.multipartUpload
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.CompleteMultipartUploadRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.CompleteMultipartUploadRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * The container for the multipart upload request information.
         */
        var multipartUpload: aws.sdk.kotlin.services.s3.model.CompletedMultipartUpload? = null
        /**
         * Confirms that the requester knows that they will be charged for the request. Bucket
         * owners need not specify this parameter in their requests. For information about downloading
         * objects from requester pays buckets, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html">Downloading Objects in
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.s3.model.CompleteMultipartUploadRequest) : this() {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.s3.model.CompleteMultipartUploadRequest = CompleteMultipartUploadRequest(this)

        /**
         * construct an [aws.sdk.kotlin.services.s3.model.CompletedMultipartUpload] inside the given [block]
         */
        fun multipartUpload(block: aws.sdk.kotlin.services.s3.model.CompletedMultipartUpload.Builder.() -> kotlin.Unit) {
            this.multipartUpload = aws.sdk.kotlin.services.s3.model.CompletedMultipartUpload.invoke(block)
        }
    }
}
