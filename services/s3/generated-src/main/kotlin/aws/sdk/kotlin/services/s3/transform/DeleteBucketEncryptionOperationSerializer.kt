...
internal class DeleteBucketEncryptionOperationSerializer: HttpSerialize<DeleteBucketEncryptionRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DeleteBucketEncryptionRequest): HttpRequestBuilder {
