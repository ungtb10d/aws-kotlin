...
public class GetPublicAccessBlockRequest private constructor(builder: Builder) {
    /**
    ...
    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.GetPublicAccessBlockRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.GetPublicAccessBlockRequest = Builder(this).apply(block).build()
