 ...
 */
class InventoryS3BucketDestination private constructor(builder: Builder) {
    /**
     ...
     * results.
     */
    val encryption: aws.sdk.kotlin.services.s3.model.InventoryEncryption? = builder.encryption
    /**
     * Specifies the output format of the inventory results.
     */
    val format: aws.sdk.kotlin.services.s3.model.InventoryFormat? = builder.format
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.InventoryS3BucketDestination = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.InventoryS3BucketDestination = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * results.
         */
        var encryption: aws.sdk.kotlin.services.s3.model.InventoryEncryption? = null
        /**
         * Specifies the output format of the inventory results.
         */
        var format: aws.sdk.kotlin.services.s3.model.InventoryFormat? = null
        /**
         * The prefix that is prepended to all inventory results.
         */
         ...
         */
        fun encryption(block: aws.sdk.kotlin.services.s3.model.InventoryEncryption.Builder.() -> kotlin.Unit) {
