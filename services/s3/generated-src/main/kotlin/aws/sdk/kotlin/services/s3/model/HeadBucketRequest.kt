...
class HeadBucketRequest private constructor(builder: Builder) {
    /**
     * The bucket name.
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.HeadBucketRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.HeadBucketRequest = Builder(this).apply(block).build()
