...
internal class DeleteBucketWebsiteOperationSerializer: HttpSerialize<DeleteBucketWebsiteRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DeleteBucketWebsiteRequest): HttpRequestBuilder {
