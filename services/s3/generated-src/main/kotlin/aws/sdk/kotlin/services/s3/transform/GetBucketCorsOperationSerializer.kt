...
internal class GetBucketCorsOperationSerializer: HttpSerialize<GetBucketCorsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetBucketCorsRequest): HttpRequestBuilder {
