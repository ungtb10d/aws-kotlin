...
internal class GetBucketTaggingOperationSerializer: HttpSerialize<GetBucketTaggingRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetBucketTaggingRequest): HttpRequestBuilder {
