 ...
 */
class NotificationConfiguration private constructor(builder: Builder) {
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.NotificationConfiguration = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.NotificationConfiguration = Builder(this).apply(block).build()
