...
class Condition private constructor(builder: Builder) {
     ...
     * applied.
     */
    val httpErrorCodeReturnedEquals: kotlin.String? = builder.httpErrorCodeReturnedEquals
    /**
     ...
     */
    val keyPrefixEquals: kotlin.String? = builder.keyPrefixEquals

    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.Condition = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.Condition = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * applied.
         */
        var httpErrorCodeReturnedEquals: kotlin.String? = null
        /**
         * The object key name prefix when the redirect is applied. For example, to redirect
         * requests for ExamplePage.html, the key prefix will be
         * ExamplePage.html. To redirect request for all pages with the prefix
         ...
         * XML related object key constraints.
         */
        var keyPrefixEquals: kotlin.String? = null
