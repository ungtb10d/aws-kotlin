...
internal class GetBucketOwnershipControlsOperationSerializer: HttpSerialize<GetBucketOwnershipControlsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetBucketOwnershipControlsRequest): HttpRequestBuilder {
