...
public class Grant private constructor(builder: Builder) {
     ...
     */
    public val permission: aws.sdk.kotlin.services.s3.model.Permission? = builder.permission

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.Grant = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.Grant = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Specifies the permission given to the grantee.
         */
        public var permission: aws.sdk.kotlin.services.s3.model.Permission? = null
