...
class CopyObjectRequest private constructor(builder: Builder) {
    /**
     ...
     */
    val metadataDirective: aws.sdk.kotlin.services.s3.model.MetadataDirective? = builder.metadataDirective
    /**
     ...
     */
    val taggingDirective: aws.sdk.kotlin.services.s3.model.TaggingDirective? = builder.taggingDirective
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.CopyObjectRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.CopyObjectRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * metadata provided in the request.
         */
        var metadataDirective: aws.sdk.kotlin.services.s3.model.MetadataDirective? = null
        /**
         * Specifies whether you want to apply a Legal Hold to the copied object.
         */
         ...
         * tag-set provided in the request.
         */
        var taggingDirective: aws.sdk.kotlin.services.s3.model.TaggingDirective? = null
        /**
         * If the bucket is configured as a website, redirects requests for this object to another
         * object in the same bucket or to an external URL. Amazon S3 stores the value of this header in
         * the object metadata.
