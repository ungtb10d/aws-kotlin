...
public class ServerSideEncryptionConfiguration private constructor(builder: Builder) {
     ...
     */
    public val rules: List<ServerSideEncryptionRule>? = builder.rules

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.ServerSideEncryptionConfiguration = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.ServerSideEncryptionConfiguration = Builder(this).apply(block).build()

    public class Builder {
        /**
         * Container for information about a particular server-side encryption configuration rule.
         */
        public var rules: List<ServerSideEncryptionRule>? = null
