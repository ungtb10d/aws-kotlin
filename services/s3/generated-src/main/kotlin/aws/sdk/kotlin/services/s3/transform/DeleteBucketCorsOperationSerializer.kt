...
internal class DeleteBucketCorsOperationSerializer: HttpSerialize<DeleteBucketCorsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DeleteBucketCorsRequest): HttpRequestBuilder {
