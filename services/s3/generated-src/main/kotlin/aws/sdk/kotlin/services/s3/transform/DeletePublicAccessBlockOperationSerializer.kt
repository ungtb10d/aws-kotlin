...
internal class DeletePublicAccessBlockOperationSerializer: HttpSerialize<DeletePublicAccessBlockRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DeletePublicAccessBlockRequest): HttpRequestBuilder {
