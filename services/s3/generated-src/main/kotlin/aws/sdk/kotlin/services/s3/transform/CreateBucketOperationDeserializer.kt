...
private suspend fun throwCreateBucketError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    ...
    val ex = when(errorDetails.code) {
        "BucketAlreadyOwnedByYou" -> BucketAlreadyOwnedByYouDeserializer().deserialize(context, wrappedResponse)
        "BucketAlreadyExists" -> BucketAlreadyExistsDeserializer().deserialize(context, wrappedResponse)
