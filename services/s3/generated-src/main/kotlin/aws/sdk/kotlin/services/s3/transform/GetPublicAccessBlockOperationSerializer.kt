...
internal class GetPublicAccessBlockOperationSerializer: HttpSerialize<GetPublicAccessBlockRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetPublicAccessBlockRequest): HttpRequestBuilder {
