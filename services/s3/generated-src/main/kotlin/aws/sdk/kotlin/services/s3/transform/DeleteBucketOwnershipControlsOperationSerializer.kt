...
internal class DeleteBucketOwnershipControlsOperationSerializer: HttpSerialize<DeleteBucketOwnershipControlsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DeleteBucketOwnershipControlsRequest): HttpRequestBuilder {
