...
internal class GetBucketAclOperationSerializer: HttpSerialize<GetBucketAclRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetBucketAclRequest): HttpRequestBuilder {
