...
internal class GetBucketWebsiteOperationSerializer: HttpSerialize<GetBucketWebsiteRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetBucketWebsiteRequest): HttpRequestBuilder {
