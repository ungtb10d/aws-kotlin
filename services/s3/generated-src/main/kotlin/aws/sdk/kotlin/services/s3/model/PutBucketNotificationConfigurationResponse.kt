...
public class PutBucketNotificationConfigurationResponse private constructor(builder: Builder) {

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.PutBucketNotificationConfigurationResponse = Builder().apply(block).build()
    }
