 ...
 */
class Redirect private constructor(builder: Builder) {
    /**
     ...
     * present.
     */
    val httpRedirectCode: kotlin.String? = builder.httpRedirectCode
    /**
     ...
     */
    val replaceKeyPrefixWith: kotlin.String? = builder.replaceKeyPrefixWith
    /**
     ...
     * XML related object key constraints.
     */
    val replaceKeyWith: kotlin.String? = builder.replaceKeyWith

    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.Redirect = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.Redirect = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * present.
         */
        var httpRedirectCode: kotlin.String? = null
        /**
         * Protocol to use when redirecting requests. The default is the protocol that is used in
         * the original request.
         */
         ...
         * XML related object key constraints.
         */
        var replaceKeyPrefixWith: kotlin.String? = null
        /**
         * The specific object key to use in the redirect request. For example, redirect request to
         * error.html. Not required if one of the siblings is present. Can be present
         * only if ReplaceKeyPrefixWith is not provided.
         ...
         * XML related object key constraints.
         */
        var replaceKeyWith: kotlin.String? = null
