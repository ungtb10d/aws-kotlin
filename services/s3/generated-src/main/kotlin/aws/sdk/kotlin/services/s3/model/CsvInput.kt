 ...
 * formatted.
 */
class CsvInput private constructor(builder: Builder) {
    /**
     * Specifies that CSV field values may contain quoted record delimiters and such records
     * should be allowed. Default value is FALSE. Setting this value to TRUE may lower
     * performance.
     */
    val allowQuotedRecordDelimiter: kotlin.Boolean = builder.allowQuotedRecordDelimiter
    /**
     ...
     * line.
     */
    val comments: kotlin.String? = builder.comments
    /**
     ...
     */
    val fileHeaderInfo: aws.sdk.kotlin.services.s3.model.FileHeaderInfo? = builder.fileHeaderInfo
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.CsvInput = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.CsvInput = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * performance.
         */
        var allowQuotedRecordDelimiter: kotlin.Boolean = false
        /**
         * A single character used to indicate that a row should be ignored when the character is
         * present at the start of that row. You can specify any character to indicate a comment
         * line.
         */
        var comments: kotlin.String? = null
        /**
         * A single character used to separate individual fields in a record. You can specify an
         * arbitrary delimiter.
         */
         ...
         * identify a column in an expression (SELECT "name" FROM OBJECT).
         */
        var fileHeaderInfo: aws.sdk.kotlin.services.s3.model.FileHeaderInfo? = null
        /**
         * A single character used for escaping when the field delimiter is part of the value. For
         * example, if the value is a, b, Amazon S3 wraps this field value in quotation marks,
         * as follows: " a , b ".
