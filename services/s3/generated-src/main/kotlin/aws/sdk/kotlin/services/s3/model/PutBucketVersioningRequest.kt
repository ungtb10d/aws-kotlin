...
public class PutBucketVersioningRequest private constructor(builder: Builder) {
     ...
     */
    public val versioningConfiguration: aws.sdk.kotlin.services.s3.model.VersioningConfiguration? = builder.versioningConfiguration

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.PutBucketVersioningRequest = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.PutBucketVersioningRequest = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * Container for setting the versioning state.
         */
        public var versioningConfiguration: aws.sdk.kotlin.services.s3.model.VersioningConfiguration? = null
         ...
         */
        public fun versioningConfiguration(block: aws.sdk.kotlin.services.s3.model.VersioningConfiguration.Builder.() -> kotlin.Unit) {
