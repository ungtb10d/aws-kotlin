...
internal class DefaultDynamoDbClient(override val config: DynamoDbClient.Config) : DynamoDbClient {
     ...
     */
    override suspend fun importTable(input: ImportTableRequest): ImportTableResponse {
        val op = SdkHttpOperation.build<ImportTableRequest, ImportTableResponse> {
            serializer = ImportTableOperationSerializer()
            deserializer = ImportTableOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
