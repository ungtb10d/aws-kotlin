 ...
 */
public class GlobalTable private constructor(builder: Builder) {
    /**
     ...
     */
    public val replicationGroup: List<Replica>? = builder.replicationGroup

    public companion object {
        public operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.GlobalTable = Builder().apply(block).build()
    }
    ...
    public inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.GlobalTable = Builder(this).apply(block).build()
    ...
    public class Builder {
         ...
         * The Regions where the global table has replicas.
         */
        public var replicationGroup: List<Replica>? = null
