 ...
 * window.
 */
class InvalidExportTimeException private constructor(builder: Builder) : DynamoDbException() {
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.InvalidExportTimeException = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.InvalidExportTimeException = Builder(this).apply(block).build()
