 ...
 */
class TableDescription private constructor(builder: Builder) {
    /**
     * Contains information about the table archive.
     */
    val archivalSummary: aws.sdk.kotlin.services.dynamodb.model.ArchivalSummary? = builder.archivalSummary
    /**
     ...
     */
    val billingModeSummary: aws.sdk.kotlin.services.dynamodb.model.BillingModeSummary? = builder.billingModeSummary
    /**
    ...
    /**
     * Represents the version of <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GlobalTables.html">global tables
     * in use, if the table is replicated across Amazon Web Services Regions.
     */
    val globalTableVersion: kotlin.String? = builder.globalTableVersion
    /**
     ...
     * For more information about primary keys, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html#DataModelPrimaryKey">Primary Key in the Amazon DynamoDB Developer
     * Guide.
     */
     ...
     * table.
     */
    val latestStreamArn: kotlin.String? = builder.latestStreamArn
    /**
     ...
     * StreamLabel
     */
    val latestStreamLabel: kotlin.String? = builder.latestStreamLabel
    /**
     ...
     */
    val restoreSummary: aws.sdk.kotlin.services.dynamodb.model.RestoreSummary? = builder.restoreSummary
    /**
     ...
     */
    val tableClassSummary: aws.sdk.kotlin.services.dynamodb.model.TableClassSummary? = builder.tableClassSummary
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.TableDescription = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.TableDescription = Builder(this).apply(block).build()

    class Builder {
        /**
         * Contains information about the table archive.
         */
        var archivalSummary: aws.sdk.kotlin.services.dynamodb.model.ArchivalSummary? = null
        /**
         * An array of AttributeDefinition objects. Each of these objects describes
         * one attribute in the table and index key schema.
         * Each AttributeDefinition object in this array is composed of:
         ...
         * Contains the details for the read/write capacity mode.
         */
        var billingModeSummary: aws.sdk.kotlin.services.dynamodb.model.BillingModeSummary? = null
        /**
         * The date and time when the table was created, in <a href="http://www.epochconverter.com/">UNIX epoch time format.
         */
         ...
         * be returned.
         */
        var globalSecondaryIndexes: List<GlobalSecondaryIndexDescription>? = null
        /**
         * Represents the version of <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GlobalTables.html">global tables
         * in use, if the table is replicated across Amazon Web Services Regions.
         */
        var globalTableVersion: kotlin.String? = null
        /**
         * The number of items in the specified table. DynamoDB updates this value approximately
         * every six hours. Recent changes might not be reflected in this value.
         */
         ...
         * table.
         */
        var latestStreamArn: kotlin.String? = null
        /**
         * A timestamp, in ISO 8601 format, for this stream.
         * Note that LatestStreamLabel is not a unique identifier for the stream,
         * because it is possible that a stream from another table might have the same timestamp.
         ...
         * StreamLabel
         */
        var latestStreamLabel: kotlin.String? = null
        /**
         * Represents one or more local secondary indexes on the table. Each index is scoped to a
         * given partition key value. Tables with one or more local secondary indexes are subject
         * to an item collection size limit, where the amount of data within a given item
         ...
         * be returned.
         */
        var localSecondaryIndexes: List<LocalSecondaryIndexDescription>? = null
        /**
         * The provisioned throughput settings for the table, consisting of read and write
         * capacity units, along with data about increases and decreases.
         */
         ...
         * Represents replicas of the table.
         */
        var replicas: List<ReplicaDescription>? = null
        /**
         * Contains details for the restore.
         */
        var restoreSummary: aws.sdk.kotlin.services.dynamodb.model.RestoreSummary? = null
        /**
         * The description of the server-side encryption status on the specified table.
         */
         ...
         * Contains details of the table class.
         */
        var tableClassSummary: aws.sdk.kotlin.services.dynamodb.model.TableClassSummary? = null
        /**
         * Unique identifier for the table for which the backup was created.
         */
         ...
         */
        fun archivalSummary(block: aws.sdk.kotlin.services.dynamodb.model.ArchivalSummary.Builder.() -> kotlin.Unit) {
         ...
         */
        fun billingModeSummary(block: aws.sdk.kotlin.services.dynamodb.model.BillingModeSummary.Builder.() -> kotlin.Unit) {
         ...
         */
        fun restoreSummary(block: aws.sdk.kotlin.services.dynamodb.model.RestoreSummary.Builder.() -> kotlin.Unit) {
         ...
         */
        fun tableClassSummary(block: aws.sdk.kotlin.services.dynamodb.model.TableClassSummary.Builder.() -> kotlin.Unit) {
