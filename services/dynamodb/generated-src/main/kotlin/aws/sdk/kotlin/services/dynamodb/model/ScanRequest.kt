...
class ScanRequest private constructor(builder: Builder) {
    ...
    /**
     * This is a legacy parameter. Use FilterExpression instead. For more
     * information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ScanFilter.html">ScanFilter in the Amazon DynamoDB Developer
     * Guide.
     */
     ...
     * TotalSegments.
     */
    val segment: kotlin.Int? = builder.segment
    /**
     ...
     * Segment.
     */
    val totalSegments: kotlin.Int? = builder.totalSegments

    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.ScanRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.ScanRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * Guide.
         */
        var scanFilter: Map<String, Condition>? = null
        /**
         * For a parallel Scan request, Segment identifies an
         * individual segment to be scanned by an application worker.
         * Segment IDs are zero-based, so the first segment is always 0. For example, if you want
         ...
         * Segment.
         */
        var totalSegments: kotlin.Int? = null
