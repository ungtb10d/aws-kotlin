 ...
 */
class ScanResponse private constructor(builder: Builder) {
    /**
     ...
     * indicates an inefficient Scan operation. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/QueryAndScan.html#Count">Count and
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.ScanResponse = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.ScanResponse = Builder(this).apply(block).build()
    ...
    class Builder {
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.dynamodb.model.ScanResponse) : this() {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.dynamodb.model.ScanResponse = ScanResponse(this)
