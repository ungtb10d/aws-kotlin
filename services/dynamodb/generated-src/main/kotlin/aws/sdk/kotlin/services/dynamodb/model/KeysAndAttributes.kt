 ...
 * and the sort key.
 */
class KeysAndAttributes private constructor(builder: Builder) {
    /**
     ...
     * For more information on expression attribute names, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.AccessingItemAttributes.html">Accessing Item Attributes in the Amazon DynamoDB Developer
     * Guide.
     */
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.KeysAndAttributes = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.KeysAndAttributes = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * with the items.
         */
        var keys: List<Map<String, AttributeValue>>? = null
        /**
         * A string that identifies one or more attributes to retrieve from the table. These
         * attributes can include scalars, sets, or elements of a JSON document. The attributes in
         * the ProjectionExpression must be separated by commas.
