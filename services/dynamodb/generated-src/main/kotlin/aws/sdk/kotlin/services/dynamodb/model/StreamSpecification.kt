 ...
 */
class StreamSpecification private constructor(builder: Builder) {
    /**
     * Indicates whether DynamoDB Streams is enabled (true) or disabled (false) on the
     * table.
     */
    val streamEnabled: kotlin.Boolean? = builder.streamEnabled
    /**
     ...
     */
    val streamViewType: aws.sdk.kotlin.services.dynamodb.model.StreamViewType? = builder.streamViewType

    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.StreamSpecification = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.StreamSpecification = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * table.
         */
        var streamEnabled: kotlin.Boolean? = null
        /**
         * When an item in the table is modified, StreamViewType determines what
         * information is written to the stream for this table. Valid values for
         * StreamViewType are:
         ...
         * item are written to the stream.
         */
        var streamViewType: aws.sdk.kotlin.services.dynamodb.model.StreamViewType? = null
