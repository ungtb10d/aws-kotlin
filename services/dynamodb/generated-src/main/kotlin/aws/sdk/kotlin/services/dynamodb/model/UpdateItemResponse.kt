 ...
 */
class UpdateItemResponse private constructor(builder: Builder) {
    /**
     ...
     * more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughputIntro.html">Provisioned Throughput in the Amazon DynamoDB Developer
     * Guide.
     */
     ...
     */
    val itemCollectionMetrics: aws.sdk.kotlin.services.dynamodb.model.ItemCollectionMetrics? = builder.itemCollectionMetrics

    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.UpdateItemResponse = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.UpdateItemResponse = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * represents one attribute.
         */
        var attributes: Map<String, AttributeValue>? = null
        /**
         * The capacity units consumed by the UpdateItem operation. The data
         * returned includes the total provisioned throughput consumed, along with statistics for
         * the table and any indexes involved in the operation. ConsumedCapacity is
         ...
         * precision or accuracy of the estimate.
         */
        var itemCollectionMetrics: aws.sdk.kotlin.services.dynamodb.model.ItemCollectionMetrics? = null
         ...
         */
        fun itemCollectionMetrics(block: aws.sdk.kotlin.services.dynamodb.model.ItemCollectionMetrics.Builder.() -> kotlin.Unit) {
