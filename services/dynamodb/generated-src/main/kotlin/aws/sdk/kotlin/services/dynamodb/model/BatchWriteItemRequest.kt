 ...
 */
class BatchWriteItemRequest private constructor(builder: Builder) {
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.BatchWriteItemRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.BatchWriteItemRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * table's attribute definition.
         */
        var requestItems: Map<String, List<WriteRequest>>? = null
        /**
         * Determines the level of detail about either provisioned or on-demand throughput
         * consumption that is returned in the response:
         * INDEXES - The response includes the aggregate
