...
internal class ListImportsOperationSerializer: HttpSerialize<ListImportsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: ListImportsRequest): HttpRequestBuilder {
        ...
        val payload = serializeListImportsOperationBody(context, input)
...
private fun serializeListImportsOperationBody(context: ExecutionContext, input: ListImportsRequest): ByteArray {
