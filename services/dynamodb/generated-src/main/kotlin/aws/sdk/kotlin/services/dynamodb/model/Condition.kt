 ...
 * the desired values.
 */
class Condition private constructor(builder: Builder) {
    /**
     ...
     * ComparisonOperator, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.html">Legacy
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.Condition = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.Condition = Builder(this).apply(block).build()
    ...
    class Builder {
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.dynamodb.model.Condition) : this() {
            this.attributeValueList = x.attributeValueList
            this.comparisonOperator = x.comparisonOperator
        }

        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.dynamodb.model.Condition = Condition(this)
    }
}
