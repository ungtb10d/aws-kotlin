...
private suspend fun throwUpdateGlobalTableError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    ...
    val ex = when(errorDetails.code) {
        ...
        "ReplicaAlreadyExistsException" -> ReplicaAlreadyExistsExceptionDeserializer().deserialize(context, wrappedResponse)
        "ReplicaNotFoundException" -> ReplicaNotFoundExceptionDeserializer().deserialize(context, wrappedResponse)
