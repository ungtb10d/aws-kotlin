...
internal class CreateBackupOperationSerializer: HttpSerialize<CreateBackupRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateBackupRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateBackupOperationBody(context, input)
...
private fun serializeCreateBackupOperationBody(context: ExecutionContext, input: CreateBackupRequest): ByteArray {
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        input.backupName?.let { field(BACKUPNAME_DESCRIPTOR, it) }
