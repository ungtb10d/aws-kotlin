...
class DescribeContributorInsightsResponse private constructor(builder: Builder) {
    /**
     ...
     */
    val failureException: aws.sdk.kotlin.services.dynamodb.model.FailureException? = builder.failureException
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.DescribeContributorInsightsResponse = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.DescribeContributorInsightsResponse = Builder(this).apply(block).build()

    class Builder {
        /**
         * List of names of the associated contributor insights rules.
         */
        var contributorInsightsRuleList: List<String>? = null
        /**
         * Current status of contributor insights.
         */
         ...
         * rules. Please retry request.
         */
        var failureException: aws.sdk.kotlin.services.dynamodb.model.FailureException? = null
        /**
         * The name of the global secondary index being described.
         */
         ...
         */
        fun failureException(block: aws.sdk.kotlin.services.dynamodb.model.FailureException.Builder.() -> kotlin.Unit) {
