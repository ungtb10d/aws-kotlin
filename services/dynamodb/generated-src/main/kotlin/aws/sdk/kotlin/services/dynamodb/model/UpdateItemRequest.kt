 ...
 */
class UpdateItemRequest private constructor(builder: Builder) {
    /**
     * This is a legacy parameter. Use UpdateExpression instead. For more
     * information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.AttributeUpdates.html">AttributeUpdates in the Amazon DynamoDB Developer
     * Guide.
     */
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.UpdateItemRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.UpdateItemRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * Guide.
         */
        var attributeUpdates: Map<String, AttributeValueUpdate>? = null
        /**
         * A condition that must be satisfied in order for a conditional update to
         * succeed.
         * An expression can contain any of the following:
