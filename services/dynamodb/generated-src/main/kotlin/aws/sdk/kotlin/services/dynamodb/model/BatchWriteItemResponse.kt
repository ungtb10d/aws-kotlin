 ...
 */
class BatchWriteItemResponse private constructor(builder: Builder) {
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.BatchWriteItemResponse = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.BatchWriteItemResponse = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * UnprocessedItems map.
         */
        var unprocessedItems: Map<String, List<WriteRequest>>? = null
