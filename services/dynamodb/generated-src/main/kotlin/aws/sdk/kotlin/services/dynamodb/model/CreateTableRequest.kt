...
class CreateTableRequest private constructor(builder: Builder) {
     ...
     * AttributeDefinitions array. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html">Data
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.dynamodb.model.CreateTableRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.dynamodb.model.CreateTableRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * global secondary index, consisting of read and write capacity units.
         */
        var globalSecondaryIndexes: List<GlobalSecondaryIndex>? = null
        /**
         * Specifies the attributes that make up the primary key for a table or an index. The
         * attributes in KeySchema must also be defined in the
         * AttributeDefinitions array. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html">Data
         ...
         * attributes when determining the total.
         */
        var localSecondaryIndexes: List<LocalSecondaryIndex>? = null
        /**
         * Represents the provisioned throughput settings for a specified table or index. The
         * settings can be modified using the UpdateTable operation.
         * If you set BillingMode as PROVISIONED, you must specify this property.
