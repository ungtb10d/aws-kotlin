...
internal class ListContributorInsightsOperationSerializer: HttpSerialize<ListContributorInsightsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: ListContributorInsightsRequest): HttpRequestBuilder {
        ...
        val payload = serializeListContributorInsightsOperationBody(context, input)
...
private fun serializeListContributorInsightsOperationBody(context: ExecutionContext, input: ListContributorInsightsRequest): ByteArray {
