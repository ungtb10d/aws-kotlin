 ...
 */
class GetFederationTokenResponse private constructor(builder: Builder) {
    /**
     ...
     */
    val federatedUser: aws.sdk.kotlin.services.sts.model.FederatedUser? = builder.federatedUser
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.sts.model.GetFederationTokenResponse = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.sts.model.GetFederationTokenResponse = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * resource-based policies, such as an Amazon S3 bucket policy.
         */
        var federatedUser: aws.sdk.kotlin.services.sts.model.FederatedUser? = null
        /**
         * A percentage value that indicates the packed size of the session policies and session
         * tags combined passed in the request. The request fails if the packed size is greater than 100 percent,
         * which means the policies and tags exceeded the allowed space.
         ...
         */
        fun federatedUser(block: aws.sdk.kotlin.services.sts.model.FederatedUser.Builder.() -> kotlin.Unit) {
