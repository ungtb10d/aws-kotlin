...
class AssumeRoleRequest private constructor(builder: Builder) {
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.sts.model.AssumeRoleRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.sts.model.AssumeRoleRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * session to any subsequent sessions.
         */
        var transitiveTagKeys: List<String>? = null
