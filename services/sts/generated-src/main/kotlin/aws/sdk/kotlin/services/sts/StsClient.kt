...
public interface StsClient : SdkClient {
    ...
    public companion object {
        public operator fun invoke(block: Config.Builder.() -> Unit): StsClient {
            val config = Config.Builder().apply(block).build()
            return DefaultStsClient(config)
        }

        public operator fun invoke(config: Config): StsClient = DefaultStsClient(config)

        /**
         * Construct a [StsClient] by resolving the configuration from the current environment.
         */
        public suspend fun fromEnvironment(block: (Config.Builder.() -> Unit)? = null): StsClient {
            val builder = Config.Builder()
            if (block != null) builder.apply(block)
            builder.region = builder.region ?: resolveRegion()
            return DefaultStsClient(builder.build())
        }
    }
     ...
     */
    public suspend fun assumeRole(input: AssumeRoleRequest): AssumeRoleResponse
     ...
     */
    public suspend fun assumeRoleWithSaml(input: AssumeRoleWithSamlRequest): AssumeRoleWithSamlResponse
     ...
     */
    public suspend fun assumeRoleWithWebIdentity(input: AssumeRoleWithWebIdentityRequest): AssumeRoleWithWebIdentityResponse
     ...
     */
    public suspend fun decodeAuthorizationMessage(input: DecodeAuthorizationMessageRequest): DecodeAuthorizationMessageResponse
     ...
     */
    public suspend fun getAccessKeyInfo(input: GetAccessKeyInfoRequest): GetAccessKeyInfoResponse
     ...
     */
    public suspend fun getCallerIdentity(input: GetCallerIdentityRequest = GetCallerIdentityRequest {}): GetCallerIdentityResponse
     ...
     */
    public suspend fun getSessionToken(input: GetSessionTokenRequest = GetSessionTokenRequest {}): GetSessionTokenResponse
}
 ...
 * To use MFA with `AssumeRole`, you pass values for the `SerialNumber` and `TokenCode` parameters. The `SerialNumber` value identifies the user's hardware or virtual MFA device. The `TokenCode` is the time-based one-time password (TOTP) that the MFA device produces.
 */
public suspend inline fun StsClient.assumeRole(crossinline block: AssumeRoleRequest.Builder.() -> Unit): AssumeRoleResponse = assumeRole(AssumeRoleRequest.Builder().apply(block).build())
 ...
 * + [Creating a Role for SAML 2.0 Federation](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-idp_saml.html) in the *IAM User Guide*.
 */
public suspend inline fun StsClient.assumeRoleWithSaml(crossinline block: AssumeRoleWithSamlRequest.Builder.() -> Unit): AssumeRoleWithSamlResponse = assumeRoleWithSaml(AssumeRoleWithSamlRequest.Builder().apply(block).build())
 ...
 * + [Web Identity Federation with Mobile Applications](http://aws.amazon.com/articles/web-identity-federation-with-mobile-applications). This article discusses web identity federation and shows an example of how to use web identity federation to get access to content in Amazon S3.
 */
public suspend inline fun StsClient.assumeRoleWithWebIdentity(crossinline block: AssumeRoleWithWebIdentityRequest.Builder.() -> Unit): AssumeRoleWithWebIdentityResponse = assumeRoleWithWebIdentity(AssumeRoleWithWebIdentityRequest.Builder().apply(block).build())
 ...
 * + The values of condition keys in the context of the user's request.
 */
public suspend inline fun StsClient.decodeAuthorizationMessage(crossinline block: DecodeAuthorizationMessageRequest.Builder.() -> Unit): DecodeAuthorizationMessageResponse = decodeAuthorizationMessage(DecodeAuthorizationMessageRequest.Builder().apply(block).build())
 ...
 * This operation does not indicate the state of the access key. The key might be active, inactive, or deleted. Active keys might not have permissions to perform an operation. Providing a deleted access key might return an error that the key doesn't exist.
 */
public suspend inline fun StsClient.getAccessKeyInfo(crossinline block: GetAccessKeyInfoRequest.Builder.() -> Unit): GetAccessKeyInfoResponse = getAccessKeyInfo(GetAccessKeyInfoRequest.Builder().apply(block).build())
 ...
 * No permissions are required to perform this operation. If an administrator adds a policy to your IAM user or role that explicitly denies access to the `sts:GetCallerIdentity` action, you can still perform this operation. Permissions are not required because the same information is returned when an IAM user or role is denied access. To view an example response, see [I Am Not Authorized to Perform: iam:DeleteVirtualMFADevice](https://docs.aws.amazon.com/IAM/latest/UserGuide/troubleshoot_general.html#troubleshoot_general_access-denied-delete-mfa) in the *IAM User Guide*.
 */
public suspend inline fun StsClient.getCallerIdentity(crossinline block: GetCallerIdentityRequest.Builder.() -> Unit): GetCallerIdentityResponse = getCallerIdentity(GetCallerIdentityRequest.Builder().apply(block).build())
 ...
 * For more information about using `GetSessionToken` to create temporary credentials, go to [Temporary Credentials for Users in Untrusted Environments](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_request.html#api_getsessiontoken) in the *IAM User Guide*.
 */
public suspend inline fun StsClient.getSessionToken(crossinline block: GetSessionTokenRequest.Builder.() -> Unit): GetSessionTokenResponse = getSessionToken(GetSessionTokenRequest.Builder().apply(block).build())
